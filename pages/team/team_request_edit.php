...
<div class="backtoresults"> 
    ...
    if(!$modal)
        {?>
        <p><a href="<?php echo $backurl != "" ? generateURL(escape($backurl)) : $baseurl_short ."pages/team/team_request.php";?>" onClick="return CentralSpaceLoad(this,true);"><?php echo LINK_CARET_BACK ?><?php echo $backurl!=""?escape($lang["back"]):escape($lang["managerequestsorders"]); ?></a></p>
        <?php
        }
        ?>
    <h1><?php echo escape($lang["editrequestorder"]);render_help_link('resourceadmin/user-resource-requests');?></h1>
</div>
<?php
if (isset($resulttext))
    {
...
if ($request !== false)
    ...
    if($modal)
        ...
        <div class="Question">
            ...
            <div class="Fixed"><a href="#" onclick="ChangeCollection(<?php echo $request["collection"]; ?>,'');"><?php echo LINK_CARET ?><?php echo escape($lang["action-selectrequesteditems"]); ?></a></div>
            <div class="clearerleft"></div>
        </div>
        <?php endif; ?>
