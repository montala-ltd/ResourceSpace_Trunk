...
// If you encounter issues with Chinese characters, use "cid0cs" and make sure GhostScript has ArialUnicodeMS font (on Windows server, this should be there already)
