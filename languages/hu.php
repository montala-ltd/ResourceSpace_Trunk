...
$lang["usergroup-archivists"] = 'Archivisták';
...
$lang["fieldtype-text_box_multi-line"] = 'Szövegdoboz (több soros)';
$lang["fieldtype-text_box_large_multi-line"] = 'Szövegdoboz (nagy, több soros)';
...
$lang["fieldtype-dynamic_keywords_list"] = 'Dinamikus kulcsszavak lista';
...
$lang["property-search_filter"] = 'Keresési szűrő';
...
$lang["property-field_constraint"] = 'Mezők megkötése';
...
$lang["information-if_you_enable_indexing_below_and_the_field_already_contains_data-you_will_need_to_reindex_this_field"] = 'Ha engedélyezi az alábbi indexelést, és a mező már tartalmaz adatokat, újra kell <a target=_blank href=../tools/reindex_field.php?field=%ref>indexelnie ezt a mezőt</a>.';
$lang["property-index_this_field"] = 'Indexeld ezt a mezőt';
$lang["information_index_warning"] = 'Kérjük, tekintse meg a <a href=\'https://www.resourcespace.com/knowledge-base/resourceadmin/indexing-metadata\' target=\'_blank\'>Tudásbázist</a> a mezőindexelés részletes információiért.';
...
$lang["property-display_field"] = 'Megjelenítési mező';
$lang["property-field_full_width"] = 'Teljes szélesség megjelenítése a nézet oldalon';
$lang["property-enable_advanced_search"] = 'Haladó keresés engedélyezése';
...
$lang["property-iptc_equiv"] = 'Iptc egyenérték';
...
$lang["property-tab_name"] = 'Füle neve';
...
$lang["property-read_only_field"] = 'Csak olvasható metaadatmező (azaz nem ír vissza a letöltéskor)';
...
$lang["property-hide_when_uploading"] = 'Feltöltéskor elrejtés';
$lang["property-hide_when_restricted"] = 'Rejtés korlátozás esetén';
...
$lang["information-derestrict_filter"] = 'Szűrő feloldása. A \'Hozzáférés korlátozása az összes elérhető erőforráshoz\' engedéllyel együtt használatra szánt. E kombináció engedélyezésével minden erőforrás korlátozva lesz, kivéve, ha a szűrőfeltétel teljesül.';
...
$lang["mycollections"] = 'Gyűjtemények';
$lang["myrequests"] = 'A kéréseim';
$lang["collections"] = 'Gyűjtemények';
$lang["mycontributions"] = 'Hozzájárulások';
...
$lang["gotoadvancedsearch"] = 'Speciális keresés';
...
$lang["usersonline"] = 'Felhasználók jelenleg online (tétlen idő percek)';
...
$lang["ticktodeletehelp"] = 'Jelölje be a szakasz törléséhez';
$lang["createnewhelp"] = 'Hozzon létre egy új súgó szekciót';
$lang["searchcontenteg"] = '(page, név, szöveg)';
$lang["copyresource"] = 'Erőforrás másolása';
$lang["resourceidnotfound"] = 'A forrásazonosító nem található';
...
$lang["manage_tabs_instructions"] = 'Használja ezt a szakaszt a fülek kezelésére. Ezek kiválaszthatók a metaadat mezők és az erőforrástípusok számára.';
$lang["tabs_create_new"] = 'Hozzon létre egy lapot, amelynek neve...';
...
$lang["view_my_contributions_ws"] = 'Nézd meg a hozzájárulásaimat - %workflow_state_name';
$lang["viewcontributedps"] = 'Nézd meg a hozzájárulásaimat - függőben lévő benyújtás';
$lang["viewcontributedpr"] = 'Nézd meg a hozzájárulásaimat - várakozó felülvizsgálatra';
$lang["viewcontributedsubittedl"] = 'Nézd meg a hozzájárulásaimat - aktív';
$lang["contributedps"] = 'Saját hozzájárulásaim - függőben lévő benyújtás';
$lang["contributedpr"] = 'Saját hozzájárulásaim - várakozó felülvizsgálatra';
$lang["contributedsubittedl"] = 'Saját hozzájárulásaim - aktív';
...
$lang["editallresources"] = 'Minden erőforrás szerkesztése a gyűjteményben';
...
$lang["removecollectionareyousure"] = 'Biztos benne, hogy el szeretné távolítani ezt a gyűjteményt a listájáról?';
$lang["managemycollections"] = 'Kezelje a gyűjteményeimet';
$lang["createnewcollection"] = 'Új gyűjtemény létrehozása';
$lang["create_new_here"] = 'Hozzon létre itt';
$lang["create_new_below"] = 'Hozzon létre egy új kategóriát';
...
$lang["action-addtocollection"] = 'Hozzáadás a gyűjteményhez';
$lang["action-removefromcollection"] = 'Eltávolítás a gyűjteményből';
$lang["addtocollection"] = 'Hozzáadás a gyűjteményhez';
...
$lang["hide_collection"] = 'Rejtés a gyűjtemény sávból';
$lang["viewall"] = 'Összes megtekintése';
$lang["selectall"] = 'Válassza az összeset';
$lang["view_all_resources"] = 'Minden erőforrás megtekintése';
$lang["action-editall"] = 'Minden szerkesztése';
$lang["edit_all_resources"] = 'Minden erőforrás szerkesztése';
$lang["hidethumbnails"] = 'Rejtse el a mini képeket';
$lang["showthumbnails"] = 'Mutasd az előnézeteket';
$lang["toggle"] = 'Átkapcsolás';
$lang["resize"] = 'Átméretezés';
$lang["contactsheet"] = 'Kapcsolati lap';
...
$lang["copycollectionremoveall"] = 'Távolítsa el az összes erőforrást másolás előtt';
...
$lang["selectcollection"] = 'Válassza ki a gyűjteményt';
$lang["total"] = 'Összesen';
...
$lang["clicklinkviewthemes"] = 'Használja az alábbi linket a kiemelt gyűjtemények megtekintéséhez.';
$lang["clicklinkviewcollections"] = 'Használja az alábbi linkeket a gyűjtemények megtekintéséhez.';
...
$lang["rightclicktodownload"] = 'Kattintson a jobb gombbal erre a linkre, és válassza a \'Cél mentése másként\' lehetőséget az erőforrás letöltéséhez...';
...
$lang["action-upload-to-collection"] = 'Töltsd fel erre a gyűjteményre';
...
$lang["previewthumbonly"] = '(előnézet / csak bélyegkép)';
$lang["rotateclockwise"] = 'Forgasd az óramutató járásával megegyezően';
$lang["rotateanticlockwise"] = 'Forgasd az óramutató járásával ellentétesen';
$lang["increasegamma"] = 'Fényesítse a előnézeteket';
$lang["decreasegamma"] = 'Sötétítse el az előnézeteket';
...
$lang["relatedresources_onupload"] = 'Minden erőforrás kapcsolása feltöltéskor';
...
$lang["youfoundresources"] = 'erőforrások';
$lang["youfoundresource"] = 'erőforrás';
$lang["youfoundresults"] = 'eredmények';
...
$lang["title"] = 'Cím';
$lang["torefineyourresults"] = 'A találatok finomításához próbálja meg';
$lang["verybestresources"] = 'A legjobb erőforrások';
$lang["addtocurrentcollection"] = 'Add to current collection';
$lang["addresource"] = 'Új erőforrás rekord létrehozása';
$lang["addresourcebatch"] = 'Erőforrás csoport hozzáadása';
$lang["fileupload"] = 'Fájl feltöltés';
$lang["clickbrowsetolocate"] = 'Kattintson a böngészésre a fájl megtalálásához';
...
$lang["options"] = 'Opciók';
$lang["previousresult"] = 'Előző eredmény';
$lang["viewallresults"] = 'Minden eredmény megtekintése';
$lang["vieworiginalresource"] = 'Eredeti erőforrás megtekintése';
$lang["nextresult"] = 'Következő eredmény';
$lang["pixels"] = 'pixelek';
...
$lang["tryselectingallcountries"] = 'Próbálja meg kiválasztani az "összes" lehetőséget az országok dobozban, vagy';
$lang["tryselectinganyyear"] = 'Próbálja meg kiválasztani az "bármely év" lehetőséget az év mezőben, vagy';
$lang["tryselectinganymonth"] = 'Próbálja meg kiválasztani az "bármely hónap" lehetőséget a hónap mezőben, vagy';
$lang["trybeinglessspecific"] = 'Próbálj meg kevésbé specifikus lenni azzal, hogy';
...
$lang["clicktoviewresource"] = 'Kattintson az alábbi linkre a forrás megtekintéséhez.';
...
$lang["lock-tooltip"] = 'Zárja le a mezőt, hogy a következő erőforráshoz másolható legyen';
$lang["resource_type_not_found"] = 'Erőforrástípus nem található.';
$lang["view_directly_in_browser"] = 'Nézd meg közvetlenül a böngészőben';
$lang["view_in_browser"] = 'Nézet böngészőben';
...
$lang["status"] = 'Állapot';
$lang["status-2"] = 'Függőben lévő benyújtás';
$lang["status-1"] = 'Függőben lévő felülvizsgálat';
$lang["status0"] = 'Aktív';
$lang["status1"] = 'Archíválásra várva';
...
$lang["keepmeloggedin"] = 'Tarts engem bejelentkezve ezen az eszközön';
$lang["username"] = 'Felhasználónév';
$lang["columnheader-username"] = 'Felhasználónév';
$lang["password"] = 'Jelszó';
$lang["login"] = 'Bejelentkezés';
$lang["loginincorrect"] = 'Sajnálom, a bejelentkezési adatai helytelenek voltak.<br /><br />Ha elfelejtette a jelszavát,<br />használja az alábbi linket egy új kéréséhez.';
$lang["accountexpired"] = 'A fiókja lejárt. Kérjük, lépjen kapcsolatba a források csapatával.';
$lang["accountnotfound-reset-not-emailed"] = 'A jelszó-visszaállító linket nem küldtek el, mert nincs olyan fiók, amelyhez ez az e-mail cím tartozik';
$lang["accountnoemail-reset-not-emailed"] = 'A jelszó-visszaállító linket nem küldtek el, mert a fióknak nincs e-mail címe';
$lang["accountexpired-reset-not-emailed"] = 'A jelszó-visszaállító linket nem küldtek el, mert a fiók lejárt';
$lang["accountnotapproved-reset-not-emailed"] = 'A jelszó-visszaállító linket nem küldtek el, mert a fiók nincs jóváhagyva';
...
$lang["ticktoemail"] = 'E-mail ezt a felhasználót a felhasználónevével és az új jelszavával';
...
$lang["createuserwithusername"] = 'Felhasználó létrehozása a felhasználónévvel...';
$lang["yourname"] = 'A teljes neved';
$lang["youremailaddress"] = 'Az e-mail címed';
$lang["sendreminder"] = 'Küldj emlékeztetőt';
$lang["sendnewpassword"] = 'Email küldése';
$lang["requestuserlogin"] = 'Kérjük a felhasználói bejelentkezést';
$lang["accountlockedstatus"] = 'A fiók zárolva van';
$lang["accountunlock"] = 'Feloldás';
$lang["account_request_label"] = 'Fiók kérés';
$lang["account_request_confirmation_email_to_requester"] = 'A kérésed egy új felhasználói fiók létrehozására megérkezett. Hamarosan fel fogják venni veled a kapcsolatot. Köszönjük!';
...
$lang["accountdisabled"] = 'A fiókja le van tiltva. Kérjük, lépjen kapcsolatba a források csapatával.';
...
$lang["noprojectname"] = 'Meg kell adnia egy projektnevet';
$lang["noprojectdescription"] = 'Meg kell adnia egy projektleírást';
...
$lang["square"] = 'Négyzet';
$lang["either"] = 'Vagy';
$lang["sendrequest"] = 'Kérjük, küldje el a kérést';
$lang["editresearchrequest"] = 'Kutatási kérés szerkesztése';
$lang["unassigned"] = 'Nem kijelölt';
$lang["requeststatus0"] = 'Nem kijelölt';
$lang["requeststatus1"] = 'Folyamatban';
$lang["requeststatus2"] = 'Teljes';
$lang["copyexistingresources"] = 'Másolja a meglévő gyűjteményben lévő erőforrásokat erre a kutatási összefoglalóra';
...
$lang["typecollectionid"] = '(Írja be a gyűjtemény azonosítóját alább)';
$lang["researchid"] = 'Kutatási azonosító';
$lang["assignedto"] = 'Hozzárendelve a';
$lang["createresearchforuser"] = 'Kutatási kérelem létrehozása a felhasználó számára';
$lang["searchresearchrequests"] = 'Kutatási Kérések Keresése';
$lang["requestasuser"] = 'Kérés felhasználóként';
$lang["haspostedresearchrequest"] = 'kutatási kérelmet tett közzé';
$lang["newresearchrequestwaiting"] = 'Új kutatási kérés várakozik';
$lang["researchrequestassignedmessage"] = 'A kutatási kérésedet az adminisztrátor csapat egyik tagjához rendeltük. Miután befejeztük a kutatást, e-mailt fogsz kapni, amely tartalmazza az összes ajánlott erőforrást.';
$lang["researchrequestassigned"] = 'Kutatási kérés hozzárendelve';
$lang["researchrequestcompletemessage"] = 'A kutatási kérésed befejeződött, és hozzá lett adva a \'saját gyűjteményeid\' oldalhoz.';
$lang["researchrequestcomplete"] = 'Kutatási kérés teljesítve';
$lang["researchrequest_custom_field_required"] = 'Hiányzik a kötelező egyedi mező \'%field\'';
$lang["selectgroupuser"] = 'Válassza ki a csoportot/felhasználót...';
...
$lang["confirmaddgroup"] = 'Biztos benne, hogy hozzá szeretné adni az összes jelenlegi tagot ehhez a csoporthoz?';
$lang["confirmaddgroupsmart"] = 'Biztos benne, hogy dinamikusan szeretné hozzáadni a tagokat ehhez a csoporthoz?';
$lang["back_to"] = 'Vissza a %area-hoz';
$lang["resourceid"] = 'Erőforrás azonosító';
$lang["columnheader-resource_id"] = 'Erőforrás azonosító';
$lang["id"] = 'ID';
$lang["todate"] = 'Eddig';
$lang["fromdate"] = 'Kezdő dátum';
$lang["day"] = 'Nap';
$lang["month"] = 'Hónap';
$lang["year"] = 'Év';
...
$lang["action-selectrequesteditems"] = 'Mutassa az összes kért elemet a gyűjteményem sávjában';
...
$lang["confirm-revertmetadata"] = 'Biztos benne, hogy újra szeretné kinyerni az eredeti metaadatokat ebből a fájlból? Ez a művelet szimulálni fogja a fájl újrafeltöltését, és elveszíti az esetlegesen módosított metaadatokat.';
...
$lang["termsmustindicateusage"] = 'Meg kell adnia a tervezett felhasználást, mielőtt folytathatja';
$lang["termsmustspecifyusagecomment"] = 'Meg kell adnia a tervezett felhasználási megjegyzéseket, mielőtt folytathatná';
$lang["proceed"] = 'Folyamatban';
$lang["contributedby"] = 'Hozzájárult:';
...
$lang["resource-0"] = 'erőforrások';
$lang["resource-1"] = 'erőforrás';
$lang["resource-2"] = 'erőforrások';
...
$lang["stat-advancedsearch"] = 'Speciális keresés';
...
$lang["cannot_share-has_upload_share"] = 'A gyűjtemény nem feltöltési megosztásai nem hozhatók létre, mivel jelenleg létezik egy feltöltési megosztás hozzá.';
...
$lang["confirmdeleteaccess"] = 'Biztos benne, hogy törölni szeretné ezt a hozzáférési kulcsot? Azok a felhasználók, akiknek ez a kulcs segítségével biztosították a hozzáférést, már nem fognak tudni hozzáférni ehhez a gyűjteményhez.';
$lang["confirmdeleteaccessresource"] = 'Biztos benne, hogy törölni szeretné ezt a hozzáférési kulcsot? Azok a felhasználók, akiknek ez a kulcs segítségével biztosították a hozzáférést, már nem fognak tudni hozzáférni ehhez az erőforráshoz.';
$lang["confirmdeleteaccessmulticol"] = 'Biztos benne, hogy törölni szeretné ezeket a hozzáférési kulcsokat? Azok a felhasználók, akiknek ezekkel a kulcsokkal biztosították a hozzáférést, már nem fognak tudni hozzáférni a megfelelő gyűjteményekhez.';
$lang["confirmdeleteaccessmultires"] = 'Biztos benne, hogy törölni szeretné ezeket a hozzáférési kulcsokat? Azok a felhasználók, akiknek ezekkel a kulcsokkal biztosították a hozzáférést, már nem fognak tudni hozzáférni a megfelelő erőforrásokhoz.';
$lang["confirmdeleteaccessmultimix"] = 'Biztos benne, hogy törölni szeretné ezeket a hozzáférési kulcsokat? Azok a felhasználók, akiknek ezekkel a kulcsokkal biztosították a hozzáférést, már nem fognak tudni hozzáférni a megfelelő gyűjteményekhez és erőforrásokhoz.';
...
$lang["selectgenerateurlexternal"] = 'A URL létrehozásához, amely működni fog külső felhasználók számára (olyan személyek, akiknek nincs bejelentkezésük), kérjük, válassza ki a hozzáférési szintet, amelyet a forrásokhoz szeretne biztosítani.';
$lang["selectgenerateurlexternalthemecat"] = 'Azoknak a külső felhasználóknak (akiknek nincs bejelentkezésük) való hozzáférést lehetővé tevő URL-ek létrehozásához kérjük, válassza ki a hozzáférési szintet, amelyet a forrásokhoz szeretne biztosítani.';
...
$lang["removeallresourcesfromcollection"] = 'Távolítsa el az összes erőforrást ebből a gyűjteményből';
$lang["remove_selected_from_collection"] = 'Eltávolítás a kiválasztottakból a gyűjteményből';
$lang["deleteallresourcesfromcollection"] = 'Minden erőforrás törlése';
$lang["deleteallsure"] = 'Biztos benne, hogy törölni szeretné ezeket a forrásokat? Ez a forrásokat magukat törli, nem csak eltávolítja őket ebből a gyűjteményből.';
...
$lang["recent"] = 'Legutóbbi';
$lang["n_recent"] = '%qty Nemrég hozzáadott erőforrások';
$lang["batchcopyfrom"] = 'Másolja az alábbi adatokat az ID-val rendelkező erőforrástól';
$lang["copy"] = 'Másolás';
...
$lang["confirmeditall"] = 'Biztos benne, hogy el szeretné menteni? Ez felülírja a kiválasztott mező(k) meglévő értékét(keit) az összes erőforrásban a jelenlegi gyűjteményében.';
$lang["confirm_edit_all_selected_resources"] = 'Biztos benne, hogy el szeretné menteni? Ez felülírja a meglévő érték(ek)et a kiválasztott mező(k)ben az összes kiválasztott erőforrás számára.';
$lang["confirmsubmitall"] = 'Biztos benne, hogy el szeretné küldeni az összeset felülvizsgálatra? Ez felülírja a kiválasztott mező(k) meglévő értékeit az összes erőforrásban a jelenlegi gyűjteményében, és mindet benyújtja felülvizsgálatra.';
$lang["confirmunsubmitall"] = 'Biztos benne, hogy vissza szeretné vonni az összeset a felülvizsgálati folyamatból? Ez felülírja a kiválasztott mező(k) meglévő értékét(keit) az összes erőforrásban az aktuális gyűjteményében, és visszavonja az összeset a felülvizsgálatból.';
$lang["confirmpublishall"] = 'Biztos benne, hogy közzé kívánja tenni? Ez felülírja a kiválasztott mező(k) meglévő érték(ek)et az összes erőforrásban a jelenlegi gyűjteményében, és mindet közzéteszi nyilvános megtekintésre.';
$lang["confirmunpublishall"] = 'Biztos benne, hogy vissza szeretné vonni ezeket az erőforrásokat? Ez felülírja a kiválasztott mező(k) meglévő érték(ek)et az összes erőforrás esetében a jelenlegi gyűjteményében, és eltávolítja őket a nyilvános megtekintésből.';
$lang["collectiondeleteconfirm"] = 'Biztos benne, hogy törölni szeretné ezt a gyűjteményt?';
$lang["hidden"] = '(hidden)';
$lang["requestnewpassword"] = 'Kérjük, új jelszó igénylése';
...
$lang["warningexpiredtext"] = 'Figyelem! Ez a forrás túllépte a lejárati dátumot. Kattintson az alábbi linkre a letöltési funkció engedélyezéséhez.';
...
$lang["replacealltext"] = 'Cserélje le az összes szöveget / lehetőséget';
...
$lang["relateallresources"] = 'Kapcsolja össze az összes erőforrást ebben a gyűjteményben';
$lang["unrelateallresources"] = 'Minden erőforrást eltávolít a gyűjteményből';
$lang["relate_selected_resources"] = 'Kapcsolja össze a kiválasztott erőforrásokat';
$lang["relateallresources_confirmation"] = 'Az összes erőforrás ebben a gyűjteményben most már kapcsolódik';
...
$lang["contactsheet_data_toolong"] = 'Túl sok adat van ahhoz, hogy egy oldalra elférjen. Kérjük, csökkentse a mezőnkénti maximális karakterek számát, a megjelenített mezők számát, vagy válasszon egy alternatív oldalnézetet.';
$lang["thumbnails"] = 'Képek előnézete';
$lang["contactsheetintrotext"] = 'Kérjük, válassza ki a konfigurációs lehetőségeket, amelyeket szeretne a kapcsolati lap PDF-jéhez. Az előnézet automatikusan frissül, amikor megváltoztatja a lehetőségeit, kivéve, ha megváltoztatja az erőforrások sorrendjét a gyűjteményben, ebben az esetben meg kell nyomnia a "Előnézet" gombot a frissítéshez.<br />Amikor készen áll, nyomja meg a "Létrehozás" gombot a kapcsolati lap PDF-jének generálásához és letöltéséhez.';
$lang["size"] = 'Méret';
$lang["orientation"] = 'Tájékoztatás';
$lang["requiredfield"] = 'Ez egy kötelező mező';
$lang["requiredfield_resource_type"] = 'Erőforrás típusa: Ez egy kötelező mező';
$lang["requiredfields"] = 'Kérjük, ellenőrizze a űrlapot, és próbálja újra. A következő mezők nincsenek kitöltve:';
$lang["requiredfields-general"] = 'Kérjük, töltse ki az összes kötelező mezőt';
...
$lang["starttypingusername"] = 'Kérjük, kezdje el beírni a felhasználónevet / teljes nevet / csoport nevét';
$lang["requestfeedback"] = 'Kérjük, adjon visszajelzést<br />(a választ e-mailben fogja megkapni)';
$lang["sendfeedback"] = 'Visszajelzés küldése';
$lang["feedbacknocomments"] = 'Nem hagytál megjegyzéseket az adott gyűjteményben található erőforrásokhoz.<br />Kattints a beszédbuborékra minden erőforrás mellett, hogy megjegyzéseket adj hozzá.';
$lang["collectionfeedback"] = 'Gyűjtemény visszajelzés';
$lang["collectionfeedbackemail"] = 'Kapott egy visszajelzést:';
...
$lang["clearcategoriesareyousure"] = 'Biztos benne, hogy törölni szeretné az összes kiválasztott opciót?';
$lang["archive"] = 'Archív';
$lang["collectionviewhover"] = 'Nézd meg az összes erőforrást ebben a gyűjteményben';
$lang["collectioncontacthover"] = 'Hozzon létre egy kapcsolati lapot az ebben a gyűjteményben található erőforrásokkal';
...
$lang["max_login_attempts_exceeded"] = 'Túllépte a maximális bejelentkezési kísérletek számát. Most ? percet kell várnia, mielőtt újra megpróbálhat bejelentkezni.';
$lang["newlogindetails"] = 'Kérjük, találja meg az új bejelentkezési adatait az alábbiakban.';
...
$lang["exportfailed"] = 'A rendszerkonfigurációs exportálás nem sikerült. Kérjük, lépjen kapcsolatba a rendszeradminisztrátorral.';
...
$lang["filedeleteconfirm"] = 'Biztos benne, hogy törölni szeretné ezt a fájlt?';
...
$lang["cannotemailpassword"] = 'Nem küldheti el a felhasználónak a meglévő jelszavát e-mailben, mivel az nincs tárolva (helyette egy kriptográfiai hash van tárolva).<br /><br />Használja a fenti \'Javasol\' gombot, amely új jelszót generál és engedélyezi az e-mail funkciót.';
$lang["userrequestnotification1"] = 'A Felhasználói Bejelentkezési Kérelem űrlap a következő adatokkal lett kitöltve:';
$lang["userrequestnotification2"] = 'Ha ez egy érvényes kérés, kérjük, látogasson el a rendszerhez az alábbi URL-en, és hozzon létre egy fiókot ennek a felhasználónak.';
...
$lang["userrequestnotificationemailprotection2"] = 'Kérjük, látogasson el a lenti URL-re, hogy összehasonlíthassa ezt a kérést a meglévő fiókkal.';
...
$lang["clicktoviewlog"] = 'Nézet napló';
$lang["addkeyword"] = 'Kulcsszó hozzáadása';
$lang["selectedresources"] = 'Kiválasztott erőforrások';
$lang["phpextensions"] = 'PHP kiterjesztések';
$lang["setup-alreadyconfigured"] = 'A ResourceSpace telepítése már konfigurálva van. A konfiguráláshoz törölheti a <pre>include/config.php</pre> fájlt, és ismét irányítsa a böngészőjét erre az oldalra.';
...
$lang["setup-successremovewrite"] = 'Most már eltávolíthatja az írási hozzáférést az \'include/\'-hoz.';
$lang["setup-visitwiki"] = 'Látogasson el a <a target="_blank" href="https://www.resourcespace.com/knowledge-base/">ResourceSpace Tudásbázisba</a> a telepítése testreszabásával kapcsolatos további információkért.';
...
$lang["setup-checkerrors"] = 'Előkonfigurációs hibák léptek fel.<br /> Kérjük, oldja meg ezeket a hibákat, és térjen vissza erre az oldalra a folytatáshoz.';
$lang["setup-errorheader"] = 'Hibák kerültek észlelésre a konfigurációdban. Lásd alább a részletes hibaüzeneteket.';
...
$lang["setup-if_mysqlserver"] = 'A MySQL szerver telepítésének IP címe vagy <abbr title="Fully Qualified Domain Name">FQDN</abbr>. Ha a MySQL a webkiszolgálóval azonos szerveren van telepítve, használja a "localhost" kifejezést.';
$lang["setup-if_mysqlusername"] = 'A felhasználónév, amelyet a MySQL szerverhez való csatlakozáshoz használnak. Ennek a felhasználónak jogokkal kell rendelkeznie az alább megnevezett adatbázisban táblák létrehozásához.';
...
$lang["setup-if_emailnotify"] = 'Az e-mail cím, ahová a források/felhasználók/kutatási kérelmeket küldik.';
...
$lang["setup-if-usesmtp"] = 'Használjon egy külső SMTP szervert a kimenő e-mailekhez (pl. Gmail). PHPMailer-t használ';
$lang["setup-if-smtphost"] = 'Gazdagép név, pl. \'smtp.gmail.com\'';
$lang["setup-if-smtpport"] = 'Port szám, pl. 465 a Gmail SSL használatával.';
$lang["setup-if-smtpauth"] = 'Küldje el a hitelesítő adatokat az SMTP szerverhez (hamis az anonim hozzáférés használatához)';
...
$lang["collectionlog-D"] = 'Minden erőforrást törölve';
...
$lang["collectionlog-t"] = 'Hozzáférés leállítva a forráshoz általa';
...
$lang["mycollection_notpublic"] = 'Nem alakíthatja a \'Készlet\' gyűjteményét kiemelt vagy nyilvános gyűjteménnyé. Kérjük, hozzon létre egy új gyűjteményt erre a célra.';
...
$lang["notapproved"] = 'Nem jóváhagyva';
$lang["disabled"] = 'Letiltva';
$lang["userrequestnotification3"] = 'Ha ez egy érvényes kérés, kattintson a linkre a részletek áttekintéséhez és a felhasználói fiók jóváhagyásához.';
$lang["ticktoapproveuser"] = 'A fiók aktiválásához a státuszt jóváhagyottra kell állítania.';
$lang["managerequestsorders"] = 'Kérések';
$lang["editrequestorder"] = 'Kérés szerkesztése';
$lang["requestorderid"] = 'Kérés azonosító';
$lang["viewrequesturl"] = 'A kérés megtekintéséhez kattintson az alábbi linkre:';
...
$lang["ppi"] = 'PPI';
$lang["useasthemethumbnail"] = 'Használja ezt az erőforrást kiemelt gyűjtemény kategória bélyegképként?';
...
$lang["confirmdeletefieldoption"] = 'Biztos benne, hogy TÖRÖLNI szeretné ezt a mezőopciót?';
...
$lang["requestall"] = 'Kérjük az összeset';
...
$lang["requestsent"] = 'A forrást kérésed benyújtásra került jóváhagyásra';
$lang["requestsenttext"] = 'A forrást kérésed benyújtásra került jóváhagyásra, és hamarosan meg fogják vizsgálni.';
$lang["requestupdated"] = 'A forrást kérésed frissítve lett';
$lang["requestassignedtouser"] = 'A forrást kérésedet % számára lett kijelölve jóváhagyásra.';
...
$lang["requestdeclined_email"] = '[img_headerlogo]<br/><br/>[message]<br/><br/>Kattintson az alábbi linkre a kért erőforrások megtekintéséhez.<br/><br/><a href=\'[url]\'>[url]</a>';
...
$lang["pleasewaitsmall"] = 'kérjük várjon';
$lang["removethisfilter"] = '(távolítsa el ezt a szűrőt)';
...
$lang["diskerror"] = 'Túllépett kvóta';
$lang["nocookies"] = 'A süti nem lett megfelelően beállítva. Kérjük, győződjön meg arról, hogy a sütik engedélyezve vannak a böngésző beállításaiban.';
...
$lang["location-details"] = 'Használja a "Húzó módot" a tűzhely pozicionálás és a panoráma között való váltáshoz. Használja a zoom vezérlőket a nagyításhoz és a kicsinyítéshez. Kattintson a Mentés gombra a tűzhely pozíció és a zoom szint mentéséhez.';
$lang["location-missing"] = 'A következő erőforrások hiányoznak geolokációs adatokkal, és nem jelennek meg az alábbi térképen. Kattintson az \'Hely hozzáadása\' gombra a geolokációs adatok szerkesztéséhez az ebben a táblázatban felsorolt minden erőforrás esetében.';
$lang["maps-disabled"] = 'Térképek letiltva.';
$lang["mapadd-introtext"] = 'Kérjük, mozgassa és nagyítsa a térképet az adott erőforrás érdeklődési területére, majd kattintson az Add Marker gombra a térkép bal oldalán található nagyító vezérlő alatt, és kattintson arra a térképhelyre, ahol az erőforrás található. A térkép jobb felső sarkában található gomb segítségével módosíthatja az alap térképet. Mentse el a térképet PNG fájlba az alsó bal sarokban található térkép gomb segítségével.';
$lang["mapadd2-introtext"] = 'A kék jelző a forrás helyét jelzi, amelyet húzással lehet mozgatni. A térkép jobb felső sarkában található gomb segítségével módosíthatja az alap térképet. A térképet a bal alsó sarokban található gomb segítségével PNG fájlba mentheti.';
...
$lang["map_download"] = 'Töltse le a térképet PNG fájlként, válasszon méretet jobbra';
...
$lang["usemetadatatemplate"] = 'Használja a metaadat sablont';
$lang["undometadatatemplate"] = '(újra a sablon kiválasztása)';
$lang["usemetadatatemplatesure"] = 'Biztos benne, hogy alkalmazni szeretné ezt a metaadat sablont? Ez törli a jelenleg megadott adatokat.';
$lang["removemetadatatemplatesure"] = 'Biztos benne, hogy el szeretné távolítani ezt a metaadat sablont? Ez törli a jelenleg megadott adatokat.';
...
$lang["downloadreport"] = 'Letöltési jelentés';
...
$lang["reportbug-login"] = 'MEGJEGYZÉS: Kattintson ide a hibakövetőbe való bejelentkezéshez, MIELŐTT a készítésre kattintana.';
$lang["reportbug-preparebutton"] = 'Hibajelentés előkészítése';
$lang["enterantispamcode"] = 'Anti-Spam, kérjük, adja meg a következő kódot';
...
$lang["indicateusage"] = 'Kérjük, írja le a tervezett felhasználását ennek az erőforrásnak.';
...
$lang["all"] = 'Minden';
$lang["allresourcessearchbar"] = 'Minden erőforrás';
$lang["allcollectionssearchbar"] = 'Minden gyűjtemény';
...
$lang["closethiswindow"] = 'Zárja be ezt az ablakot';
$lang["requestaddedtocollection"] = 'Ez a forrás hozzá lett adva a jelenlegi gyűjteményéhez. A gyűjteményben lévő tételek kéréséhez kattintson a \\\'Kérje az összeset\\\' gombra az alábbi gyűjtemény sávon.';
$lang["subcategories"] = 'Alkategóriák';
$lang["subcategory"] = 'Alkategória';
$lang["back"] = 'Vissza';
$lang["pleasewait"] = 'Kérjük, várjon...';
$lang["autorotate"] = 'Képek automatikus elforgatása?';
$lang["user_pref_autorotate"] = 'Automatikusan elforgatja a képeket feltöltéskor?';
$lang["run_report_on_search_results"] = 'Futtass jelentést ezekről az eredményekről';
...
$lang["report_delete_periodic_email_link"] = 'A jelentés törléséhez kattintson az alábbi hivatkozásra:';
$lang["report_periodic_email_delete_title"] = 'Időszakos e-mail törlése';
$lang["report_periodic_email_delete_confirmation"] = 'Kérjük, erősítse meg, hogy törölni szeretné ezt';
$lang["deleted"] = 'Törölve';
$lang["report_periodic_email_deletion_confirmed"] = 'A periódikus jelentés törölve lett';
...
$lang["report-select-required"] = 'Kérjük, válasszon egy jelentést';
...
$lang["specificdays"] = 'Specifikus napok száma';
$lang["specificdaterange"] = 'Specifikus dátumtartomány';
...
$lang["newemailreportcreated"] = 'Új időszakos e-mail készült. Ezt a linket a levél alján található hivatkozással törölheti.';
$lang["unsubscribereport"] = 'A jelentésről való leiratkozáshoz kattintson az alábbi linkre:';
$lang["unsubscribed"] = 'Leiratkozva';
$lang["youhaveunsubscribedreport"] = 'Leiratkoztál a periódikus jelentés e-mailről.';
...
$lang["writeaccesstoplugins"] = 'Írási hozzáférés a /plugins-hoz';
$lang["nowriteaccesstoplugins"] = '/plugins mappa nem írható';
$lang["writeaccess_sql_log"] = 'Írási hozzáférés az SQL naplóhoz:';
$lang["write_access_to"] = 'Írási hozzáférés a';
$lang["nowriteaccesstohomeanim"] = 'nem írható. Nyissa meg a jogosultságokat a kezdő animáció vágási funkció engedélyezéséhez a transzformáló pluginban.';
$lang["blockedbrowsingoffilestore"] = 'A \'filestore\' könyvtár böngészésének blokkolása';
$lang["noblockedbrowsingoffilestore"] = 'A filestore mappa böngészhetőnek tűnik. Kérjük, távolítsa el az \'Indexes\' elemet az Apache \'Options\' listájából, vagy tiltsa le az \'autoindex\' modult az Apachén.';
...
$lang["zipcommand_overridden"] = 'De kérjük, vegye figyelembe, hogy a $zipcommand definiálva van és felül van írva.';
$lang["lastscheduledtaskexection"] = 'Utolsó ütemezett feladat végrehajtás (napok)';
$lang["executecronphp"] = 'A relevancia egyeztetés nem lesz hatékony, és időszakos e-mail jelentések nem lesznek küldve. Biztosítsa, hogy a <a href=\'../batch/cron.php\'>batch/cron.php</a> legalább naponta egyszer végrehajtásra kerüljön egy cron feladat vagy hasonló segítségével.';
...
$lang["server_timezone_check"] = 'A PHP időzóna megegyezik a MySQL által használtal.';
$lang["server_timezone_check_fail"] = 'A PHP időzóna "%phptz%", a MySQL időzóna "%mysqltz%"';
$lang["server_apcu_check_fail"] = 'A php-apcu kiterjesztés nincs telepítve. Engedélyezze ezt, hogy a feltöltések gyorsabbak és ellenállóbbak legyenek';
$lang["error_suggest_apcu"] = 'Kérjük, lépjen kapcsolatba a rendszeradminisztrátorával a php-apcu modul engedélyezéséhez';
$lang["upload_error_unknown"] = 'Váratlan hiba lépett fel. Kérjük, ellenőrizze, hogy a fájlnév érvényes-e. Ha a probléma továbbra is fennáll, kérjük, lépjen kapcsolatba a rendszergazdával.';
...
$lang["zoom"] = 'Zoom';
$lang["deletion_instruction"] = 'Hagyja üresen és mentse a fájl törléséhez';
$lang["upload_file"] = 'Fájl feltöltése';
$lang["item_deleted"] = 'Elem törölve';
$lang["viewing_version_created_by"] = 'Verzió megtekintése, amelyet készített';
$lang["launchpermissionsmanager"] = 'Indítsa el a jogosultságkezelőt';
$lang["confirm-deletion"] = 'Biztos benne, hogy törölni szeretné?';
$lang["accept_png_gif_only"] = 'Csak .png vagy .gif kiterjesztések elfogadottak';
$lang["ensure_file_extension_match"] = 'Biztosítsa, hogy a fájl és a kiterjesztés egyezzen';
$lang["permissionsmanager"] = 'Engedélykezelő';
$lang["backtogroupmanagement"] = 'Vissza a csoportkezeléshez';
$lang["copypermissions"] = 'Másolja a jogosultságokat a felhasználói csoporttól, amelynek az azonosítója';
$lang["confirmcopypermissions"] = 'Ez felülírja az összes engedélyt, amely jelenleg definiálva van ehhez a felhasználói csoporthoz. Biztos benne?';
...
$lang["access_to_restricted_and_confidential_resources"] = 'Letöltheti a korlátozott erőforrásokat és megtekintheti a bizalmas erőforrásokat<br>(általában csak adminisztrátorok számára)';
...
$lang["show_watermarked_previews_and_thumbnails"] = 'Mutassa a vízjellel ellátott előnézeteket/miniaturákat';
$lang["can_see_all_fields"] = 'Láthatja az összes mezőt';
$lang["can_see_field"] = 'Látható mező';
$lang["can_edit_all_fields"] = 'Minden mezőt szerkeszthet<br>(szerkeszthető erőforrások esetén)';
$lang["can_edit_field"] = 'Szerkesztheti a mezőt';
...
$lang["deny_edit_resource_type"] = 'Tagadja meg a szerkesztési hozzáférést a következő típusú erőforráshoz';
$lang["deny_edit_all_resource_types"] = 'Tagadja meg a szerkesztési hozzáférést minden erőforrástípushoz, kivéve azokat, amelyeket a "Erőforrások szerkesztésére jogosult típus" jogosultságok határoznak meg';
$lang["can_edit_resource_type"] = 'Szerkesztheti a [resourcetype] típusú erőforrásokat. Figyelmen kívül hagyva, ha a "Minden erőforrástípus szerkesztési hozzáférésének megtagadása" engedély (lásd fent) nincs jelen';
...
$lang["can_create_resources_and_upload_files-admins"] = 'Létrehozhat erőforrásokat / feltölthet fájlokat<br>(adminisztrátor felhasználók; az erőforrások \'Aktív\' állapotba kerülnek)';
$lang["can_create_resources_and_upload_files-general_users"] = 'Létrehozhat erőforrásokat / feltölthet fájlokat<br>(normál felhasználók; az erőforrások \'Függőben lévő benyújtás\' állapotba kerülnek a Saját hozzájárulásaimon keresztül)';
...
$lang["ticktodeletethisresearchrequest"] = 'Jelölje be a kérés törléséhez';
$lang["done"] = 'Kész.';
...
$lang["geographicsearch_help"] = 'Húzza a keresési terület kiválasztásához';
$lang["search_results_overlimit"] = 'Túl sok erőforrást találtunk. Kérjük, finomítsa a keresést, hogy engedélyezze ezt a nézetet.';
...
$lang["purgeuserscommand"] = 'Törölje azokat a felhasználói fiókokat, amelyek az utolsó % hónapban inaktívak voltak, és amelyek ezen időszak előtt lettek létrehozva.';
$lang["purgeusersconfirm"] = 'Ez törölni fog % felhasználói fiókot. Biztos benne?';
$lang["purgeusersconfirmdisable"] = 'Ez letiltja a(z) % felhasználói fiókot. Biztos benne?';
$lang["pleaseenteravalidnumber"] = 'Kérjük, adjon meg egy érvényes számot';
$lang["purgeusersnousers"] = 'Nincsenek felhasználók, akiket törölni lehetne.';
$lang["editallresourcetypewarning"] = 'Figyelmeztetés: a forrástípus megváltoztatása törli a kiválasztott forrásokhoz jelenleg tárolt, forrástípusra vonatkozó összes metaadatot.';
$lang["editresourcetypewarning"] = 'Figyelmeztetés: a forrástípus megváltoztatása törli az ehhez a forráshoz jelenleg tárolt, forrástípusra vonatkozó összes metaadatot.';
$lang["geodragmode"] = 'Húzó mód';
$lang["geodragmodearea"] = 'pozíció rögzítése';
$lang["geodragmodeareaselect"] = 'válassza ki a keresési területet';
$lang["substituted_original"] = 'helyettesített eredeti';
$lang["use_original_if_size"] = 'Használja az eredetit, ha a kiválasztott méret nem elérhető?';
...
$lang["action-delete_permanently"] = 'Törlés véglegesen';
...
$lang["emptycollection"] = 'Távolítsa el az összes erőforrást';
$lang["emptycollectionareyousure"] = 'Biztos benne, hogy el szeretné távolítani az összes erőforrást ebből a gyűjteményből?';
...
$lang["error-cant-request-all-are-open"] = 'Nem kérheti az összes erőforrást, mert hozzáférése van mindegyik letöltéséhez.';
$lang["error-editpermissiondenied"] = 'Nincsenek szerkesztési jogosultságai egyes vagy az összes erőforráshoz.';
$lang["error-permissions-login"] = 'Kérjük, jelentkezzen be a lap eléréséhez';
...
$lang["intro-local_upload"] = 'Válasszon ki egy vagy több fájlt a helyi feltöltési mappából, majd kattintson a \'Feltöltés\' gombra. Miután a fájlok feltöltésre kerültek, törölhetők a feltöltési mappából.';
$lang["intro-single_upload"] = 'Kattintson a \'Böngészés\' gombra, hogy megtaláljon egy fájlt, majd kattintson a \'Feltöltés indítása\' gombra.';
$lang["intro-plupload"] = 'Böngésszen a fájlok között, vagy húzza és ejtse, majd kattintson a \'Feltöltés indítása\' gombra';
$lang["intro-plupload_upload-replace_resource"] = 'Kattintson az \'Fájlok hozzáadása\' gombra, hogy megtaláljon egy fájlt, majd kattintson a \'Feltöltés indítása\' gombra.';
$lang["intro-batch_edit"] = 'Kérjük, adja meg az alapértelmezett feltöltési beállításokat és az alapértelmezett értékeket a feltöltésre kerülő erőforrások metaadataihoz.';
...
$lang["owned_by_you-1"] = '(<strong>1</strong> a te tulajdonod)';
$lang["owned_by_you-2"] = '(<strong>%mynumber</strong> a te tulajdonod)';
$lang["listresources"] = 'Erőforrások:';
$lang["action-log"] = 'Nézet napló';
$lang["saveuserlist"] = 'Mentse el ezt a listát';
$lang["deleteuserlist"] = 'Törölje ezt a listát';
$lang["typeauserlistname"] = 'Írja be a felhasználói lista nevét...';
$lang["loadasaveduserlist"] = 'Töltsön be egy mentett felhasználói listát';
...
$lang["confirmcollectiondownload"] = 'Kérjük, várjon, amíg létrehozzuk az archívumot. Ez eltarthat egy ideig, a forrásaik összes méretétől függően.';
$lang["collectiondownloadinprogress"] = 'Kérjük, várjon, amíg létrehozzuk az archívumot. Ez eltarthat egy ideig, a forrásaik összméretétől függően.<br /><br />A további munkához <a href=\\"home.php\\" target=\\"_blank\\">> Nyisson meg egy új böngészőablakot</a><br /><br />';
$lang["preparingzip"] = 'Előkészítés...';
$lang["filesaddedtozip"] = 'fájlok másolva';
$lang["fileaddedtozip"] = 'fájl másolva';
$lang["zipping"] = 'Csomagolás';
$lang["zipcomplete"] = 'A Zip fájl letöltése elindult. Eltávozhat erről az oldalról.';
$lang["starttypingkeyword"] = 'Kezdje el gépelni a kulcsszót...';
...
$lang["requestnotassignedtoyou"] = 'Sajnálom, ez a kérés már nem van hozzád rendelve. Most % felhasználónak van rendelve.';
$lang["requestassignedtoyou"] = 'Erőforrás-kérelem hozzád rendelve';
$lang["requestassignedtoyoumail"] = 'Egy erőforrás-kérelem került hozzád jóváhagyásra. Kérjük, használd az alábbi linket az erőforrás-kérelem jóváhagyásához vagy elutasításához.';
...
$lang["collection_disk_usage"] = 'Az összes erőforrás által használt lemezterület';
...
$lang["save-error"] = 'Hiba az automatikus mentés során - kérjük, mentse el manuálisan';
$lang["save-conflict-error"] = 'Szerkesztési ütközés. Kérjük, töltsd újra az oldalt';
$lang["save-conflict-multiple"] = 'Szerkesztési ütközés. Kérjük, töltsd újra az oldalt';
...
$lang["error-pageload"] = 'Sajnáljuk, hiba történt az oldal betöltésekor. Ha keresést végez, kérjük, próbálja meg finomítani a keresési lekérdezését. Ha a probléma továbbra is fennáll, kérjük, lépjen kapcsolatba a rendszeradminisztrátorral.';
$lang["copy-field"] = 'Másolás mező';
...
$lang["report-send-all-users"] = 'Küldje el a jelentést az összes aktív felhasználónak?';
...
$lang["contact_sheet_field_template"] = 'Válassza ki a kapcsolattartó lap metaadat mező sablont';
...
$lang["contact_sheet_select_fields"] = 'Válassza ki a megjelenítendő metaadatmezőket a kapcsolati lapon';
$lang["contact_sheet-add_logo_option"] = 'Hozzáadja a logót az egyes oldalak tetejére?';
...
$lang["allresources"] = 'Minden erőforrás';
...
$lang["secureyouradminaccount"] = 'Üdvözöljük! A szerver biztonságának érdekében most meg kell változtatnia az alapértelmezett jelszót.';
$lang["resources-all-types"] = 'Minden típusú erőforrások';
$lang["search-mode"] = 'Keresés...';
$lang["action-viewmatchingresults"] = 'Megfelelő eredmények megtekintése';
$lang["nomatchingresults"] = 'Nincs megfelelő találat';
$lang["matchingresults"] = 'megfelelő eredmények';
$lang["resources"] = 'Erőforrások';
...
$lang["comments_box-policy-placeholder"] = 'Kérjük, adjon hozzá szöveget a comments_policy bejegyzéshez az oldal szövegében';
...
$lang["comments_body-placeholder"] = 'Hozzáadás egy megjegyzést. Használj @(felhasználónév) említést az emberek megjelöléséhez.';
$lang["comments_fullname-placeholder"] = 'A neved (kötelező)';
$lang["comments_email-placeholder"] = 'Az Ön e-mail címe (kötelező)';
$lang["comments_website-url-placeholder"] = 'Weboldal';
$lang["comments_flag-this-comment"] = 'Zászló';
...
$lang["comments_validation-fields-failed"] = 'Kérjük, győződjön meg arról, hogy az összes kötelező mező helyesen ki van töltve';
$lang["comments_block_comment_label"] = 'blokkolás megjegyzés';
$lang["comments_flag-email-default-subject"] = 'Megjegyzés jelzéséről szóló értesítés';
$lang["comments_flag-email-default-body"] = 'Ez a megjegyzés figyelmeztetve lett:';
$lang["comments_flag-email-flagged-by"] = 'Jelölte:';
$lang["comments_flag-email-flagged-reason"] = 'A zászlózás oka:';
$lang["comments_hide-comment-text-link"] = 'Törlés';
$lang["comments_hide-comment-text-confirm"] = 'Biztos benne, hogy el akarja távolítani a szöveget erről a megjegyzésről?';
$lang["request_id"] = 'Kérés azonosító:';
$lang["user_made_request"] = 'A következő felhasználó kérvényt nyújtott be:';
$lang["download_collection"] = 'Gyűjtemény letöltése';
$lang["all-resourcetypes"] = 'erőforrások';
$lang["all-collectiontypes"] = 'gyűjtemények';
$lang["resourcetypes-no_collections"] = 'Minden %resourcetypes%';
$lang["no_resourcetypes-collections"] = 'Minden %collectiontypes%';
$lang["resourcetypes-collections"] = 'Minden %resourcetypes% és minden %collectiontypes%';
$lang["hide_view_access_to_workflow_state"] = 'Blokkolja a hozzáférést a munkafolyamat állapotához';
$lang["collection_share_status_warning"] = 'Figyelmeztetés - ez a gyűjtemény olyan állapotú erőforrásokat tartalmaz, kérjük, ellenőrizze, hogy ezek az erőforrások elérhetők lesznek más felhasználók számára';
$lang["contactadmin"] = 'Lépjen kapcsolatba a rendszergazdával';
$lang["contactadminintro"] = 'Kérjük, írja be üzenetét, és kattintson a \'Küldés\' gombra.';
...
$lang["download_usage_option_blocked"] = 'Ez a használati lehetőség nem elérhető. Kérjük, ellenőrizze az adminisztrátorával.';
$lang["tagcloudtext"] = 'Milyen metaadat kifejezésekkel jelölték meg az emberek az erőforrásokat? Minél többször használták a kifejezést, annál nagyobbnak tűnik a felhőben.<br /><br />Bármelyik kifejezésre kattintva is végrehajthatja a keresést.';
...
$lang["batch_replace_filename_intro"] = 'A források egy csoportjának cseréjéhez feltöltheti a fájlokat, amelyek nevei megegyeznek az egyedi forrásazonosítókkal. Alternatívaként kiválaszthat egy metaadat mezőt, amely a fájlneveket tartalmazza, és a rendszer megkeresi a megfelelő fájlneveket a feltöltött fájlok között, hogy azonosítsa a cserélendő fájlt.';
$lang["batch_replace_use_resourceid"] = 'Fájlnevek összehangolása az erőforrás-azonosítókkal';
$lang["batch_replace_filename_field_select"] = 'Kérjük, válassza ki a fájlnevet tartalmazó mezőt.';
...
$lang["page-subtitle_user_group_management"] = 'Használja ezt a szakaszt felhasználói csoportok hozzáadására, eltávolítására és módosítására.';
$lang["action-title_create_user_group_called"] = 'Hozzon létre egy felhasználói csoportot, amelynek neve...';
...
$lang["fieldhelp-permissions_filter"] = 'Bevihet egyetlen engedélyt vagy vesszővel elválasztott engedélyeket. Részleges engedélynevek és helyettesítők nem megengedettek. Az engedélyek kis- és nagybetű érzékenyek.';
$lang["group_download_limit_title"] = 'Erőforrás letöltési korlát. Állítsa 0-ra a korlát eltörléséhez';
...
$lang["page-subtitle_user_group_management_edit"] = 'Használja ezt a szakaszt a felhasználói csoport tulajdonságainak módosításához.';
$lang["action-title_remove_user_group_logo"] = 'Jelölje be a felhasználói csoport logójának eltávolításához';
$lang["action-title_see_wiki_for_user_group_advanced_options"] = 'Kérjük, forduljon a <a href=\'https://www.resourcespace.com/knowledge-base/systemadmin/advanced-user-group-options\'>Tudásbázishoz</a> további segítségért az Advanced opciókkal kapcsolatban.';
...
$lang["page-subtitle_report_management"] = 'Használja ezt a szakaszt a rendszerjelentések módosításához.';
$lang["action-title_create_report_called"] = 'Hozzon létre egy jelentést a következő néven...';
$lang["page-title_report_management_edit"] = 'Jelentés szerkesztése';
$lang["page-subtitle_report_management_edit"] = 'Használja ezt a szakaszt a jelentés tartalmának módosításához.';
$lang["fieldtitle-tick_to_delete_report"] = 'Jelölje be a jelentés törléséhez';
$lang["report_query_required"] = 'Jelentés lekérdezés szükséges';
$lang["page-title_size_management"] = 'Kép méretek';
$lang["page-subtitle_size_management"] = 'Használja ezt a szakaszt a letöltések és előnézetek méretének módosításához.';
$lang["action-title_create_size_with_id"] = 'Hozzon létre méretet az azonosítóval...';
$lang["page-title_size_management_edit"] = 'Méret szerkesztése';
$lang["page-subtitle_size_management_edit"] = 'Használja ezt a szakaszt a méretadatok módosításához.';
$lang["fieldtitle-tick_to_delete_size"] = 'Jelölje be a méret törléséhez';
...
$lang["admin_advanced_field_properties"] = 'Fejlett mező tulajdonságok';
...
$lang["admin_delete_field_error"] = 'Nem lehet törölni a mezőt. Kérjük, lépjen kapcsolatba a rendszeradminisztrátorával. Ez a mező a következő konfigurációs lehetőségekhez van használva:-';
$lang["admin_delete_field_error_scopes"] = 'Nem lehet törölni a mezőt. Kérjük, lépjen kapcsolatba a rendszeradminisztrátorával. Ez a mező még mindig használatban van ezeken a területeken:';
$lang["admin_resource_type_create"] = 'Hozzon létre egy erőforrástípust, amelyet...';
$lang["admin_resource_type_field"] = 'Metaadat mező';
$lang["admin_resource_type_field_count"] = 'Metaadat mezők';
$lang["admin_resource_type_field_create"] = 'Hozzon létre egy metadatamezőt, amelynek neve...';
$lang["admin_resource_type_field_reorder_information"] = 'A megjelenítési sorrend módosításához rendezze át a sorokat a táblázatban húzással és ejtéssel.';
...
$lang["admin_resource_type_field_reorder_mode"] = 'Mutassa a megjelenítési sorrendben a mezők átrendezésének engedélyezéséhez húzással és ejtéssel';
...
$lang["admin_resource_type_field_migrate_data_prompt"] = 'Szeretné áthelyezni a meglévő adatokat?';
$lang["admin_resource_type_field_cannot_migrate_data_prompt"] = 'A forráselemek adatai nem migrálhatók egy rögzített lista mezőből egy szövegmezőbe. Folytatni szeretné?';
...
$lang["fieldhelp-add_to_config_override"] = 'Válassza a konfiguráció felülírását a súgó megtekintéséhez';
$lang["fieldhelp-no_config_override_help"] = 'Nincs segítség ehhez a konfigurációs elemhez';
$lang["fieldhelp-tick_to_delete_group"] = 'Nem törölheti azokat a felhasználói csoportokat, amelyek aktív felhasználókat tartalmaznak, vagy amelyek más csoportok szülői.';
...
$lang["fieldtitle-tick_to_delete_group"] = 'Jelölje be a csoport törléséhez';
...
$lang["resource_type_delete_assoc_rtf_confirm"] = '%COUNT metaadat mező(k) kapcsolódik ehhez a forrástípushoz.';
$lang["resource_type_delete_select_new"] = 'Kérjük, válassza ki azt az erőforrástípust, amelyre ezek át lesznek állítva.';
...
$lang["show_resources"] = 'Mutasd a forrásokat';
...
$lang["action-move-up"] = 'Feljebb lép';
$lang["action-move-down"] = 'Lépj le';
$lang["action-move-to"] = 'Áthelyezés ide';
$lang["delete_user_group_checkbox_alert_message"] = 'Kérjük, vegye figyelembe, hogy ez a művelet törli az összes olyan tartalom szöveget is, amely releváns volt ehhez a felhasználói csoporthoz. [recordscount] rekord található a Tartalom kezelése alatt.';
...
[text_footer]';
$lang["all__footer"] = 'Powered by <a target="_blank" href="https://www.resourcespace.com/">ResourceSpace Nyílt Forráskódú Digitális Eszközkezelés</a>';
$lang["all__researchrequest"] = 'Hagyja, hogy az erőforrásaink csapata megtalálja az Ön által szükséges erőforrásokat.';
$lang["change_language__introtext"] = 'Kérjük, válassza ki az alábbi nyelvek közül.';
$lang["collection_download__write_metadata_on_download_label"] = 'Beágyazza a forrás metaadatait a letöltött fájl(ok)ba? Ennek engedélyezése lelassítja a letöltést.';
$lang["collection_edit__introtext"] = 'Szervezze és kezelje munkáját az erőforrások csoportosításával. Hozzon létre gyűjteményeket az Ön munkastílusának megfelelően.
...
<br /><br />';
$lang["collection_email__introtext"] = 'Kérjük, töltse ki az alábbi űrlapot.<br />A címzettek e-mailt vagy rendszerüzenetet fognak kapni, amely tartalmazza a gyűjteményekhez vezető linkeket fájlcsatolmányok helyett, így kiválaszthatják és letölthetik a megfelelő erőforrásokat.';
$lang["collection_email__introtextthemeshare"] = 'Töltse ki az alábbi űrlapot, hogy e-mailben elküldje a kiemelt gyűjteményeket ebben a kiemelt gyűjtemény kategóriában. A címzettek egy e-mailt fognak kapni, amely tartalmazza a linkeket a kiemelt gyűjteményekhez.';
$lang["collection_manage__findpublic"] = 'A nyilvános gyűjtemények olyan erőforrások csoportjai, amelyeket a rendszer felhasználói széles körben elérhetővé tesznek. Adjon meg egy gyűjteményazonosítót, vagy a gyűjtemény nevének vagy felhasználónévnek teljes vagy részleges részét a nyilvános gyűjtemények kereséséhez. Adja hozzá őket a gyűjteményei listájához az erőforrások eléréséhez.';
$lang["collection_manage__introtext"] = 'Szervezze és kezelje munkáját az erőforrások csoportosításával. Hozzon létre \'Gyűjteményeket\', hogy megfeleljenek a munkastílusának. Lehet, hogy szeretné az erőforrásokat olyan projektek alá csoportosítani, amelyeken függetlenül dolgozik, megosztani az erőforrásokat egy projektcsapat között, vagy egyszerűen csak a kedvenc erőforrásait egy helyen tartani. Az összes gyűjtemény a listájában megjelenik a \'Saját gyűjteményeim\' panelen a képernyő alján.';
$lang["collection_manage__newcollection"] = 'Új gyűjtemény létrehozásához adjon meg egy rövid nevet.';
$lang["collection_public__introtext"] = 'A nyilvános gyűjteményeket más felhasználók hozzák létre.';
$lang["contact__contact"] = 'Az Ön elérhetőségei itt.';
$lang["contribute__introtext"] = 'Hozzáadhatja saját erőforrásait. Amikor először létrehoz egy erőforrást, az "Ellenőrzésre vár" státuszban van. Miután feltöltötte a fájlt és szerkesztette a mezőket, állítsa a státusz mezőt "Ellenőrzés alatt" értékre. Ezt követően az erőforrásokat kezelő csapat átnézi.';
...
$lang["download_click__introtext"] = 'A forrásfájl letöltéséhez kattintson a jobb gombbal az alábbi linkre, és válassza a "Mentés másként..." lehetőséget. Ezután megkérdezik, hová szeretné menteni a fájlt. A fájl megnyitásához a böngészőjében egyszerűen kattintson a linkre.';
...
$lang["edit__multiple"] = 'Kérjük, válassza ki azokat a mezőket, amelyeket felül szeretne írni. Azok a mezők, amelyeket nem választ ki, érintetlenek maradnak.';
$lang["home__restrictedtext"] = 'Kérjük, kattintson a linkre, amelyet e-mailben kapott, hogy hozzáférjen az Ön számára kiválasztott erőforrásokhoz.';
$lang["home__restrictedtitle"] = 'Üdvözöljük a ResourceSpace [ver] alkalmazásban';
$lang["home__welcometext"] = 'A egyszerű, gyors és ingyenes módja digitális eszközeid rendszerezésének.';
$lang["home__welcometitle"] = 'Üdvözöljük a ResourceSpace [ver] alkalmazásban';
$lang["login__welcomelogin"] = 'Üdvözöljük a ResourceSpace-ben. Kérjük, jelentkezzen be.';
$lang["local_tz"] = 'Helyi időzóna';
$lang["research_request__introtext"] = 'A szakmai kutatóink itt vannak, hogy segítsenek Önnek a legjobb források megtalálásában a projektjeihez. Kérjük, töltse ki ezt a űrlapot a lehető legteljesebben, hogy pontosan tudjuk teljesíteni a kritériumait. <br /><br />A kutatócsoport egy tagja lesz kijelölve az Ön kérésére. Folyamatosan kapcsolatban maradunk e-mailben a folyamat során, és miután befejeztük a kutatást, egy e-mailt fog kapni, amely tartalmazza az összes ajánlott forrást.';
$lang["resource_email__introtext"] = 'Gyorsan megoszthatja ezt az erőforrást más felhasználókkal e-mailben. Egy link automatikusan elküldésre kerül. Bármilyen üzenetet is hozzáadhat az e-mailhez.';
$lang["resource_request__introtext"] = 'A kérésed majdnem kész. Kérjük, add meg a kérésed okát, hogy hatékonyan tudjunk válaszolni.';
$lang["search_advanced__introtext"] = '<strong>Keresési tipp</strong><br />Bármelyik mező, amelyet üresen hagy vagy nem jelöl be, az összes kifejezést tartalmazza a keresésben. Például, ha az összes ország mezőt üresen hagyja, a keresés az összes ország eredményeit visszaadja. Ha csak az \'Algéria\' lehetőséget választja, akkor az eredmények CSAK \'Algéria\' forrásait fogják tartalmazni.';
...
$lang["team_user__introtext"] = 'Használja ezt a szakaszt felhasználók hozzáadására, eltávolítására és módosítására.';
$lang["team_user__confirm-deletion"] = 'Biztos benne, hogy véglegesen törölni szeretné ezt a felhasználót?';
...
$lang["user_preferences__introtext"] = 'Írjon be egy új jelszót az alábbi mezőbe a jelszó megváltoztatásához.';
$lang["user_preferences__introtext_new"] = 'Kérjük, adjon meg egy jelszót az alábbi mezőbe.';
$lang["user_request__introtext"] = 'Kérjük, töltse ki az alábbi űrlapot a felhasználói fiók igényléséhez.';
...
$lang["passwordresetemail"] = 'Kérjük, kattintson az alábbi linkre a jelszó visszaállításához.';
...
$lang["passwordnewemail"] = 'Kérjük, kattintson az alábbi hivatkozásra, hogy új jelszót állítson be a fiókjához.';
$lang["passwordresetexternalauth"] = 'A fiókja nincs hitelesítve a ResourceSpace által. Kérjük, lépjen kapcsolatba a rendszergazdájával a bejelentkezési utasításokért.';
$lang["passwordlinkexpired"] = 'A jelszó visszaállító hivatkozás vagy lejárt, vagy már felhasználásra került. Kérjük, jelentkezzen be, vagy kérjen egy új hivatkozást.';
$lang["passwordresetnotpossible"] = 'A jelszó-visszaállítási kérelmét nem sikerült teljesíteni.';
$lang["done__user_password_link_sent"] = 'Ha az e-mail címedet érvényes fiókhoz tartozónak ismerték el, akkor egy e-mailt küldtünk, amely tartalmaz egy linket a jelszavad visszaállításához.<br /><br /> Ha nem kapsz e-mailt, és úgy gondolod, hogy a fiókod érvényes, kérlek, ellenőrizd az e-mail szűrőidet, mielőtt kapcsolatba lépnél a rendszergazdával.';
$lang["user_password__introtextreset"] = 'Kérjük, adja meg az e-mail címét, és egy linket fog kapni, amellyel visszaállíthatja a jelszavát.';
$lang["ticktoemaillink"] = 'E-mail felhasználónak egy linket, hogy visszaállíthassa a jelszavát';
...
$lang["externalshare_using_permissions_from_user_group"] = 'Ha külső felhasználóknak küld e-mailt, kérjük, válassza ki a felhasználói csoportot, amelyet az hozzáféréshez használ.';
$lang["collection_download_too_large"] = 'Sajnálom, ez a gyűjtemény túl nagy ahhoz, hogy egy fájlként letöltsük. Próbálja meg csökkenteni a gyűjtemény méretét, vagy válasszon egy kisebb képméretet.';
$lang["all__passwordnewemailhtml"] = '[img_headerlogo][welcome]<br/><br/>Kérjük, kattintson az alábbi linkre, hogy új jelszót állítson be a fiókjához.<br/><br/><a href="[url]" target="_blank" >[url]</a><br/><br/>Az új felhasználóneve: [username]<br/><br/>[text_footer]';
$lang["disk_size_no_upload_heading"] = 'A feltöltés ideiglenesen nem elérhető';
$lang["disk_size_no_upload_explain"] = 'A helyhiány miatt a feltöltés ideiglenesen le van tiltva. Elnézést kérünk az esetleges kellemetlenségekért.';
$lang["dash"] = 'Vezérlőpult';
$lang["savethissearchtodash"] = 'Mentés a műszerfal csempére';
$lang["createnewdashtile"] = 'Új műszerfal csempe létrehozása';
$lang["specialdashtiles"] = 'Különleges csempecsoportok';
$lang["editdashtile"] = 'Szerkeszd a műszerfal csempét';
$lang["existingdashtilefound-2"] = 'A megadott tábla már létezik. Kérjük, látogasson el a következő oldalra a felülvizsgálathoz és frissítéshez: <a href="?edit=[existing_tile_ref]">Tábla szerkesztése</a>';
$lang["createdashtilefreetext"] = 'Hozzon létre csak szöveges csempe';
$lang["enterdefaultorderby"] = 'Adja meg az alapértelmezett pozíció számot';
$lang["dashtiletitle"] = 'Cím';
$lang["dashtiletext"] = 'Szöveg';
$lang["dashtilelink"] = 'Csempe cél link';
$lang["nodashtilefound"] = 'Nem található megfelelő műszerfal csempe';
$lang["existingdashtilefound"] = 'A megadott csempe már létezik a műszerfaladon.';
$lang["invaliddashtile"] = 'Érvénytelen dash csempe hivatkozás';
$lang["dashtilestyle"] = 'Irányítópult csempe stílus';
$lang["returntopreviouspage"] = 'Vissza az előző oldalra';
$lang["showresourcecount"] = 'Mutassuk a források számát?';
$lang["tilebin"] = 'Eltávolítás';
$lang["last"] = 'Utolsó';
$lang["managedefaultdash"] = 'Minden felhasználói csempe';
...
$lang["manage_all_dash"] = 'Alapértelmezett műszerfal / összes felhasználói csempe';
$lang["manage_all_dash_perm"] = 'Alapértelmezett irányítópult kezelése / minden felhasználói csempe';
$lang["dashtiledeleteaction"] = 'Milyen törlési műveletet szeretne végrehajtani?';
$lang["confirmdashtiledelete"] = 'Törölje a csempét a műszerfalamról';
...
$lang["confirmdefaultdashtiledelete"] = 'Törölje a csempét minden felhasználó számára';
$lang["dashtiledelete"] = 'Törlés csempe';
...
$lang["confirmdeleteconfigtile"] = 'Ez a csempe a konfigurációs opció(k) által van vezérelve. A csempe végleges törléséhez kapcsolja ki a megfelelő opciókat, majd hajtsa végre újra ezt a műveletet.';
...
$lang["dasheditchangeall_users"] = 'A beállítás kikapcsolása nem távolítja el ezt a csempét az összes irányítópultból, ezt a kezelési lehetőségek közül kell megtenni az összes felhasználói csempe kezelésénél. Azonban az új felhasználók már nem kapják meg ezt a csempét az irányítópultjukon.';
$lang["dashtilevisitlink"] = 'Látogassa meg a cél linket';
$lang["alluserprebuiltdashtiles"] = 'Hozzon létre előre elkészített műszerfal csempéket (minden felhasználó számára hozzáadva)';
$lang["manageowndashinto"] = 'Kezelje a műszerfal csempéit, amelyek elérhetők az Ön műszerfalán. Csempéket adhat hozzá, távolíthat el vagy szerkeszthet, ha rendelkezik a szükséges jogosultságokkal.';
$lang["manage_all_user_dash_tiles_note"] = 'Megjegyzés: A piros kerettel megjelenített csempék rejtve vannak a felhasználók számára. Az adminisztrátorok látják őket, mivel más csempék is elérhetők, de rejtve vannak ezek elől a felhasználók elől.';
$lang["manage_dash_tiles"] = 'Irányítópult csempék';
$lang["view_tiles"] = 'Nézet csempék';
$lang["upgrade_available_title"] = 'Frissítés elérhető';
$lang["upgrade_available_text"] = 'Nézze meg a verzióinformációt a ResourceSpace weboldalon';
...
Ahhoz, hogy a letöltési fájlnevet a lehető legközelebb tartsuk a régi formátumhoz, kérjük, frissítse a konfigurációs felülírást a következővel:
...
$lang["modifyuserpreferencesintro"] = 'Az ezen az oldalon található lehetőségek lehetővé teszik, hogy módosításokat végezzen a rendelkezésre álló funkciókban és felhasználói felületen.';
...
$lang["userpreference_default_perpage_label"] = 'Alapértelmezett oldalanként';
...
$lang["userpreference_resource_view_modal_label"] = 'Erőforrás nézet modális';
$lang["userpreference_modal_default"] = 'Standard oldalak megjelenítése egy modális (felugró) ablakban, ahol engedélyezve van?';
$lang["userpreference_thumbs_default_label"] = 'Alapértelmezett gyűjtemény sáv megjelenítése';
$lang["userpreference_basic_simple_search_label"] = 'Alap egyszerű keresés';
$lang["userpreference_hide_search_resource_types"] = 'Rejtse el az erőforrás típusokat az egyszerű és a fejlett keresésnél';
$lang["userpreference_cc_me_label"] = 'CC me when sending resources and collections';
$lang["userpreference_email_me_label"] = 'Kérlek, küldj nekem e-maileket a rendszerértesítések helyett, ahol lehetséges';
$lang["userpreference_email_digest_label"] = 'Kérlek, küldj nekem egy napi összefoglalót az értesítésekről, ahelyett, hogy külön e-maileket küldenél.';
$lang["userpreference_system_management_notifications"] = 'Kérlek, küldj nekem üzeneteket a fontos rendszereseményekről, pl. alacsony lemezterület.';
$lang["userpreference_user_management_notifications"] = 'Kérlek, küldj felhasználói adminisztrációs üzeneteket, pl. új felhasználói fiók kérelmeket';
$lang["userpreference_resource_access_notifications"] = 'Kérlek, küldj nekem üzeneteket az erőforrásokhoz való hozzáférésről, pl. erőforrás-kérések';
$lang["userpreference_resource_notifications"] = 'Kérlek, küldj nekem erőforrás üzeneteket az erőforrás kezeléséről, pl. erőforrás állapotváltozások, metaadat változások';
$lang["userpreference_exiftool_write_metadata_label"] = 'Írja be az beágyazott metaadatokat a letöltéskor (lehetőséget biztosít arra, hogy ezt csak a gyűjtemény letöltésekor válassza)';
$lang["userpreference_keyboard_navigation"] = 'Billentyűzet navigáció';
$lang["userpreference_tilenav"] = 'Használjon csempe elrendezést a navigációs menükhöz';
$lang["userpreference_tilenavdefault"] = 'Használjon csempe elrendezést a navigációs menükhöz (alapértelmezett beállítás; a felhasználók módosíthatják ezt)';
...
$lang["systemconfig_description"] = 'A ezen az oldalon található lehetőségek rendszerszintűek, és megváltoztathatják a felhasználók számára elérhető funkciók egy részét. Kérjük, vegye figyelembe, hogy bármely felhasználó-specifikus lehetőség, ha be van állítva, elsőbbséget élvez.';
...
$lang["systemconfig_allow_account_request_label"] = 'Engedélyezze a felhasználók számára, hogy fiókokat kérjenek';
...
$lang["systemconfig_password_expiry_label"] = 'Hányszor járnak le a jelszavak, napokban';
$lang["systemconfig_max_login_attempts_per_ip_label"] = 'Hány sikertelen bejelentkezési kísérlet engedélyezett IP-címenként, amíg ideiglenes tilalmat nem helyeznek el erre az IP-re';
$lang["systemconfig_max_login_attempts_per_username_label"] = 'Hány sikertelen bejelentkezési kísérlet engedélyezett felhasználónév szerint, amíg ideiglenes tilalmat kap ez az IP?';
...
$lang["systemconfig_option_not_allowed_error"] = 'A lehetőség nem engedélyezett! Kérjük, lépjen kapcsolatba a rendszeradminisztrátorral.';
...
$lang["systemconfig_use_native_input_for_date_field"] = 'Használja a natív dátumbevitelt a \'dátum\' metaadat mezőtípus megjelenítéséhez';
...
$lang["error_check_html_first"] = 'Kérjük, ellenőrizze a HTML-t! A használt szöveg nem tartalmaz érvényes HTML-t.';
$lang["error_generic"] = 'Sajnálom, hiba történt. Ha a hiba továbbra is fennáll, kérjük, lépjen kapcsolatba a rendszeradminisztrátorával.';
$lang["error_generic_misconfiguration"] = 'Kérjük, lépjen kapcsolatba a rendszeradminisztrátorával, és kérje meg őt, hogy oldja meg a \'Telepítési ellenőrzés\' oldalon talált problémákat.';
$lang["error_invalid_input"] = 'Érvénytelen kérés érkezett. Ha úgy gondolja, hogy ez egy jogos kérés, kérjük, lépjen kapcsolatba a rendszeradminisztrátorával.';
$lang["error_no_metadata"] = 'Nem található metaadat a(z) ehhez a forrástípushoz.';
$lang["maximise"] = 'Maximalizálás';
$lang["actions-select"] = 'Műveletek...';
$lang["actions"] = 'Műveletek';
$lang["actions-total"] = 'Összes művelet';
$lang["actions-enable"] = 'Engedélyezze az akciók funkciót minden felhasználó számára? Ha ez le van tiltva, akkor a csoportengedélyek alapján még mindig engedélyezhető.';
...
$lang["profile"] = 'A profilom';
$lang["profile_introtext"] = 'Ezen az oldalon megadhatja profilinformációit és feltöltheti profilképét JPG / JPEG formátumban.';
...
$lang["mymessages_markread"] = 'Jelöld meg olvasva';
$lang["mymessages_markunread"] = 'Jelöld olvasatlannak';
$lang["mymessages_markallread"] = 'Jelöld meg az összeset olvasottnak';
...
$lang["confirm_remove_custom_usergroup_access"] = 'Ez visszavonja az összes egyedi felhasználói csoport hozzáférést. Biztos benne?';
...
$lang["manage_metadata_text"] = 'Használja ezt az oldalt a rendelkezésre álló mezőopciók módosításához. Ez automatikusan frissíti a meglévő kiválasztott erőforrásopciókat';
$lang["confirm_delete_field_value"] = 'Biztos benne, hogy törölni szeretné ezt a mezőopciót? Ez véglegesen eltávolítja az értéket az összes erőforrásból, amelyre alkalmazva van.';
...
$lang["manage-slideshow-instructions"] = 'Egy diavetítés kép több területen is megjeleníthető a rendszeren. Más helyek kiválasztásához kérjük, jelölje be az alábbi jelölőnégyzeteket. Kattinthat a kép előnézetére is, és megtekintheti a hozzá kapcsolódó erőforrás részleteit (ha van ilyen).';
...
$lang["emailusercollectionrequest"] = 'A kérésed a forrásra benyújtásra került jóváhagyásra, és hamarosan meg fogják vizsgálni.:<br /><br />Kérés oka: [requestreason]<br /><br />Használja az alábbi linket a kért források megtekintéséhez.<br /><a href=\'[url]\'>[url]</a>';
$lang["user_pref_show_notifications"] = 'Mutasd a rendszer értesítéseit a képernyőn, ahogy érkeznek. Ha le van tiltva, a számláló továbbra is frissülni fog, hogy jelezze az új üzenetek jelenlétét.';
$lang["user_pref_daily_digest"] = 'Kérlek, küldj nekem egy napi e-mailt az összes olvasatlan értesítéssel az elmúlt 24 órából.';
...
$lang["user_pref_daily_digest_mark_read"] = 'Jelöld meg az üzeneteket olvasottként, miután megkaptam az összefoglaló e-mailt';
$lang["user_pref_email_and_user_notifications"] = 'Kérlek, küldj nekem e-maileket a rendszer értesítések mellett';
$lang["notification_email_subject"] = 'Értesítő e-mail';
$lang["mymessages_introtext"] = 'Beállíthatja, hogy mely üzenetek jelenjenek meg itt a felhasználói beállításainak megváltoztatásával';
...
$lang["permission_manage_external_shares"] = 'Képes kezelni a külső megosztásokat, amelyek lejárati ideje "Soha" van beállítva';
...
$lang["all_resource_types"] = 'Minden erőforrástípus';
...
$lang["report_please_enter_name"] = 'Kérjük, adjon meg egy jelentésnevet a jelentés mentéséhez.';
...
$lang["actions_modal"] = 'Mutassa az akciólinkeket, pl. felhasználói kérések, erőforrás-kérések egy modális (felugró) ablakban?';
$lang["actions_resource_review_default"] = 'Alapértelmezés szerint mutassa az szerkeszthető erőforrásokat az akciólistákban';
$lang["actions_notify_states"] = 'A következő állapotú szerkeszthető erőforrások megjelennek';
$lang["actions_resource_types_hide"] = 'Ne mutassa a következő típusú szerkeszthető erőforrásokat';
$lang["actions_resource_requests"] = 'Mutasd a forráskéréseket az én tevékenységeim listájában';
$lang["actions_resource_requests_default"] = 'Alapértelmezés szerint a forráskéréseket mutassa a műveleti listákban';
$lang["actions_account_requests"] = 'Mutasd a felhasználói fiók kérelmeket az én tevékenységeim listámban';
$lang["actions_account_requests_default"] = 'Alapértelmezés szerint a fiókigények megjelenítése az akciólistákban';
$lang["actions_approve_hide_groups"] = 'Ne mutasd a fiókigényléseket a következő csoportok számára';
...
$lang["actions_add_editable_to_collection"] = 'Add meg minden szerkeszthető erőforrást a gyűjteményhez';
...
$lang["upload_first_then_set_metadata"] = 'Először töltsd fel, majd állítsd be a metaadatokat';
$lang["set_metadata_then_upload"] = 'Állítsa be a metaadatokat először, majd töltse fel';
...
$lang["byte_prefix_mode_decimal"] = 'Használjon tizedes számot a fájlméretekhez (1000-es szorzók, KB/MB/GB/TB) a bináris (1024-es szorzók, KiB/MiB/GiB/TiB) helyett';
$lang["error_upload_resource_alternatives_batch"] = 'Amikor ezt a funkciót használja (lásd $upload_alternatives_suffix), az eredeti fájlnak KELL az elsőnek lennie a sorban!';
$lang["error_upload_resource_not_found"] = 'Nem található erőforrás-azonosító!';
$lang["error_user_registration_opt_in"] = 'Kérjük, jelölje be a négyzetet a hozzájárulásának jelzésére';
$lang["error_resource_id_non_numeric"] = 'HIBA - A forrásazonosítóknak numerikusnak kell lenniük, kérjük, ellenőrizze a benyújtását';
$lang["error_resource_not_image_extension"] = 'HIBA - A kiválasztott erőforrás nem képtípusú fájlkiterjesztés';
$lang["error_save_not_allowed_fc_has_children"] = 'Nem sikerült elmenteni a változtatást. Kérjük, győződjön meg róla, hogy nincsenek más kiemelt gyűjtemények vagy kiemelt gyűjtemény kategóriák ezen a gyűjteményen belül';
$lang["error_multiple_preview_tools"] = 'Kérjük, tiltsa le a jelenlegi előnézeti eszközt, majd próbálja meg újra.';
$lang["missing_folder"] = 'HIBA - Az feltöltési mappa elérési útja nincs beállítva.';
$lang["error_upload_replace_file_fail"] = 'Nem sikerült a forrást fájl cseréje';
$lang["error_upload_replace_file_fail_invalid_collection"] = 'Nem sikerült a forrást fájl cseréje. A megadott gyűjtemény hivatkozás érvénytelen.';
...
$lang["error_upload_file_move_failed"] = 'Nem sikerült áthelyezni a feltöltött fájlt. Kérjük, ellenőrizze a feltölteni kívánt fájl méretét.';
...
$lang["api-help"] = 'Kérjük, hivatkozzon a <a target="_blank" href="https://www.resourcespace.com/knowledge-base/api">API dokumentációra</a> a funkciók részleteiért. <strong>Legyen óvatos - bármely parancs, amelyet beír, a valós adataival lesz végrehajtva.</strong>';
...
$lang["property-include_in_csv_export"] = 'CSV exportba való beillesztés';
$lang["share-set-password"] = 'Megosztás jelszó';
$lang["share-enter-password"] = 'Kérjük, adja meg a hozzáférési jelszót a folytatáshoz';
$lang["share-invalid"] = 'Érvénytelen hozzáférési kulcs vagy jelszó';
$lang["share-password-not-set"] = 'A külső megosztásokat jelszóval kell védeni. Kérjük, adjon meg egy megosztási jelszót a folytatáshoz.';
$lang["oj-collection-download-success-text"] = 'Gyűjtemény letöltésre kész';
$lang["oj-collection-download-failure-text"] = 'Nem sikerült előkészíteni a gyűjtemény archívumát a letöltéshez';
$lang["oj-batch-replace-local-success-text"] = 'A csoportos csere sikeresen kicserélte a %TOTALRESOURCES erőforrást';
$lang["oj-batch-replace-local-failure-text"] = 'Tömeges csere sikertelen. Kérjük, ellenőrizze a naplókat a hibákért';
...
$lang["user_pref_inactive_digest"] = 'Küldjön nekem egy napi e-mailt az összes olvasatlan értesítéssel, ha több mint [days] napja nem jelentkeztem be?';
...
$lang["see_log"] = 'Kérjük, a lenti naplóra hivatkozzon a feltöltés további részleteiért.';
$lang["filter_migration"] = 'Szűrő migráció';
$lang["filter_migrate_success"] = 'A szűrő sikeresen átkerült.';
$lang["filter_migrate_error"] = 'Hiba lépett fel egy szűrő migrálása során. Kérjük, ellenőrizze a szűrőt.';
...
$lang["filter_edit_text"] = 'Állítsa be a szabályokat, amelyeket teljesíteni kell ahhoz, hogy az erőforrások megfeleljenek a szűrőnek';
...
$lang["error-invalid_browse_action"] = 'Érvénytelen művelet. Kérjük, ellenőrizze a meglévő erőforrásadatokat';
...
$lang["replacebatch_resource_min"] = 'Legalacsonyabb erőforrás-azonosító a cseréhez (figyelmen kívül hagyva, ha egy gyűjtemény van megadva)';
$lang["replacebatch_resource_max"] = 'Legmagasabb erőforrás-azonosító cseréje';
$lang["replacebatch_collection"] = 'Adjon meg egy gyűjteményazonosítót, ha csak az ebben a gyűjteményben lévő erőforrásokat szeretné cserélni';
$lang["replacebatch_job_created"] = 'Tömeges cserefeladat létrehozva. Értesítést fog kapni, amikor a feladat befejeződött.';
...
$lang["file_integrity_summary_failed"] = 'A forrástár fájlok nem teljesítették az integritási ellenőrzéseket, vagy hiányoznak. Kérjük, kövesse a link(ek)et, hogy megtekinthesse ezeket a forrásokat, és tegyen meg minden szükséges intézkedést, pl. állítsa vissza a fájlokat a biztonsági mentésből.';
...
$lang["file_integrity_fail_all"] = 'Nézze meg az összes erőforrást, amely fájl integritási hibákkal rendelkezik';
...
$lang["invalid_date_error2"] = 'Hiba: érvénytelen dátumérték: \'%date%\'. Kérjük, használja a következő formátumot: \'yyyy-mm-dd hh:mm:ss\' (az idő opcionális)';
$lang["invalid_date_generic"] = 'Érvénytelen dátumot adott meg';
$lang["error_server_missing_module"] = 'A szerver hiányolja a szükséges szoftvert: [module]. Kérjük, lépjen kapcsolatba a rendszergazdával.';
$lang["error_check_config"] = 'Kérjük, ellenőrizze a [config_option] konfigurációs lehetőséget';
$lang["useaspreviewimage"] = 'Használja előnézeti képként';
$lang["filechecksum"] = 'Fájl ellenőrző összeg';
$lang["system_notification"] = '[application_name] - rendszer értesítés';
$lang["error_edit_filter_invalid"] = 'A szerkesztési szűrő nincs megfelelően konfigurálva ehhez a felhasználói csoporthoz. Kérjük, lépjen kapcsolatba a rendszergazdával.';
$lang["error_search_filter_invalid"] = 'A keresési szűrő nincs megfelelően beállítva ehhez a felhasználói csoporthoz. Kérjük, lépjen kapcsolatba a rendszergazdával.';
$lang["action_lock"] = 'Zár';
$lang["action_unlock"] = 'Felszabadít';
...
$lang["search_engine_noindex"] = 'Kérjük, hogy a keresőmotorok ne indexeljék ezt az oldalt';
$lang["search_engine_noindex_external_shares"] = 'Kérjük, hogy a keresőmotorok ne indexeljék a külső megosztásokat';
...
$lang["job_confirm_purge"] = 'Biztos benne, hogy törölni szeretné az összes befejezett vagy meghiúsult feladatot?';
$lang["job_data"] = 'Munkadatok';
$lang["job_value"] = 'Érték';
$lang["job_boost"] = 'Növelje a feladatot';
$lang["job_priority"] = 'Prioritás';
$lang["csv_export_offline_option"] = 'Generálj CSV fájlt offline? Ezt nagy eredményhalmazokhoz kell használni. Értesítést kapsz egy ResourceSpace üzenetben, amint a CSV elérhető.';
$lang["csv_export_filename"] = 'metaadat_export_[keresés]_[idő]';
$lang["csv_export_file_ready"] = 'A CSV exportja készen áll';
$lang["offline_processing_disabled"] = 'Az offline feladatfeldolgozás nincs konfigurálva ezen a rendszeren. Ennek engedélyezéséhez kérjük, lépjen kapcsolatba a rendszeradminisztrátorával.';
...
$lang["action-share-upload-link"] = 'Oszd meg a feltöltési linket';
$lang["action-email-upload-link"] = 'Küldj email linket közvetlenül';
$lang["title-upload-link-create"] = 'Hozzon létre külső feltöltési linket';
$lang["permission_share_upload_link"] = 'Létrehozhat külső gyűjtemény feltöltési hivatkozásokat';
$lang["button-upload-link-create"] = 'Hozzon létre hivatkozást';
...
$lang["warning-upload-instructions"] = 'Kérjük, állítsa be a szükséges feltöltési link opciókat';
$lang["upload_share_email_users"] = 'E-mail a felhasználóknak<br><br>Írja be az e-mail címeket, vesszővel elválasztva';
$lang["upload_share_email_subject"] = 'Küldtek neked egy feltöltési linket innen';
$lang["upload_share_email_text"] = 'küldött neked egy linket fájlok feltöltéséhez a következőhöz';
$lang["upload_share_email_password"] = 'Használja ezt a jelszót a hivatkozás eléréséhez';
$lang["upload_share_email_clicklink"] = 'Kérjük, használja az alábbi linket a feltöltés megkezdéséhez';
$lang["upload_share_complete"] = 'Köszönjük a feltöltést. Kérjük, használja az alábbi gombot további erőforrások feltöltéséhez.';
...
$lang["error_no_resources_edit"] = 'Nincsenek szerkeszthető erőforrások. Ha éppen most töltött fel fájlokat, kérjük, jelezze ezt a hibát.';
...
$lang["share_confirm_purge"] = 'Biztos benne, hogy törölni szeretné az összes lejárt megosztást?';
$lang["external_shares_view_existing"] = 'Nézze meg a meglévő feltöltési megosztásokat ehhez a gyűjteményhez.';
$lang["share_user"] = 'Megosztva általa';
...
$lang["intro-plupload_external_share"] = 'Kérjük, használja ezt az oldalt a fájlok feltöltésére. Miután a fájlok feltöltődtek, átirányítjuk egy olyan oldalra, ahol megadhatja a saját adatait és a feltöltött fájlokkal kapcsolatos információkat. Kérjük, töltse ki ezeket az adatokat, különben a fájlokat törölhetjük.';
...
$lang["error-file-permissions"] = 'Nem lehet fájlműveletet végrehajtani. Kérjük, ellenőrizze a fájl jogosultságait a [path] helyen.';
...
$lang["upload_droparea_text"] = 'Húzza ide a fájlokat, vagy %{browse}';
$lang["upload_start"] = 'Kezdje el a feltöltést';
...
$lang["error_invalid_revert_option"] = 'A korábban tárolt \'[value]\' érték nem található a jelenlegi lehetőségek között. Kérjük, ellenőrizze, hogy megváltozott-e ennek a lehetőségnek a neve, és szükség esetén manuálisan frissítse az erőforrást.';
$lang["error_invalid_revert_date"] = 'A korábban tárolt dátum \'[value]\' érvénytelen. Kérjük, frissítse a forrást manuálisan, ha szükséges.';
...
$lang["batch_edit_save_warning_alert"] = 'Hiba lépett fel a művelet végrehajtása során. Kérjük, nézze meg az üzeneteit a további részletekért.';
...
$lang["error-reload-required"] = 'A ResourceSpace frissítve lett. Kérjük, töltsd újra az oldalt.';
...
$lang["pull_images_text"] = 'Használj képeket a kapcsolódó forrásokból, ha nincs elérhető kép';
...
$lang["missing_file"] = 'Ez a fájl hiányzik. Kérjük, lépjen kapcsolatba a rendszeradminisztrátorával.';
...
$lang["setup-mysqlerrorlogin"] = 'Bejelentkezés sikertelen. (Ellenőrizze a felhasználónevet és a jelszót.)';
$lang["edit_map_introtext"] = 'Kérjük, navigáljon a térkép nézetére, majd kattintson a térképre az erőforrás helyének jelölőjének megtalálásához. Mentse el a legutolsó geolokációt a Mentés gombbal, majd kattintson a \'Vissza az erőforrás szerkesztéséhez vagy geolokációs gyűjteményhez\' lehetőségre a visszatéréshez. Egy adott hely vagy földrajzi jellemző nevének kereséséhez használja a jobb felső kereső gombot. A térkép alapját a jobb felső térképrétegek gomb segítségével módosíthatja. Mentse el a térképet PNG fájlba az alsó bal térkép gomb használatával.';
...
$lang["error_file_upload_cond-MissingSourceFile"] = 'A forrásfájl hiányzik. Kérjük, lépjen kapcsolatba a rendszergazdával.';
$lang["error_file_upload_cond-EmptySourceFile"] = 'Érvénytelen forrásfájl, mert üres (nincs tartalma; a fájl mérete nulla)';
$lang["profile-tooltip"] = 'Profiladatainak kezelése';
$lang["password-tooltip"] = 'Változtassa meg a fiók jelszavát';
$lang["languageselection-tooltip"] = 'Változtassa meg a felhasználói felület nyelvét';
$lang["mycontributions-tooltip"] = 'Nézd meg a hozzájárult erőforrásaidat';
$lang["mycollections-tooltip"] = 'Kezelje a gyűjteményeit és végezzen el rajtuk műveleteket';
...
$lang["my_jobs-tooltip"] = 'Ellenőrizze az offline feladatai állapotát';
$lang["my_shares-tooltip"] = 'Kezelje a külső megosztásait';
$lang["dash-tooltip"] = 'Kezelje a rendelkezésre álló műszerfal csempéket a műszerfalához';
$lang["userpreferences-tooltip"] = 'Állítsa be a személyes preferenciáit';
$lang["logout-tooltip"] = 'Kijelentkezés a ResourceSpace-ből';
$lang["manageresources-tooltip"] = 'Hozzon létre, cserélje le és nézze meg az erőforrásokat';
$lang["managerequestsorders-tooltip"] = 'Kezelje a felhasználók kéréseit az erőforrásokhoz való hozzáféréshez';
...
$lang["admin_resource_type_fields-tooltip"] = 'Hozzon létre és konfiguráljon metaadat mezőket';
$lang["filter_manage-tooltip"] = 'Hozzon létre és konfiguráljon keresési szűrőket az erőforrásokhoz való hozzáférés szabályozásához';
$lang["page-title_report_management-tooltip"] = 'Hozzon létre vagy szerkesszen jelentéseket a rendszerben való futtatáshoz';
...
$lang["pluginssetup-tooltip"] = 'Engedélyezze és konfigurálja a bővítményeket a további funkciók hozzáadásához';
$lang["manage_slideshow-tooltip"] = 'Állítsa be a diavetítés képeit és azt, hogy hol tekinthetők meg';
$lang["manage_jobs-tooltip"] = 'Ellenőrizze az offline feladatok állapotát a rendszer egész területén';
...
$lang["system_tabs-tooltip"] = 'Fülek kezelése a forrásokhoz tartozó metaadatok csoportosításához';
$lang["installationcheck-tooltip"] = 'Ellenőrizze a rendszerbeállításokat és a függőségeket';
...
$lang["group_config_inherit"] = 'A csoport konfigurációja az szülő felhasználói csoporttól öröklődik. Itt nincs mit konfigurálni.';
