...
$lang["vr_view_projection_value"]='Valor necessário para habilitar a visualização VR';
...
$lang["vr_view_yaw_only_field"]='Campo usado para determinar se o roll/pitch deve ser impedido (opcional, o padrão é falso se não definido)';
