...
$lang['action_dates_email_range_restrict'] = "The following resources are due to be restricted within [days_min] to [days_max] days.";
$lang['action_dates_email_range_state'] = "The following resources are due to change state within [days_min] to [days_max] days.";
$lang['action_dates_email_range'] = "The following resources are due to be restricted and/or change state within [days_min] to [days_max] days.";
