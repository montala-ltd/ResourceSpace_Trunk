...
$lang["museumplus_host_api"]='Anfitrión de API (solo para llamadas de API; generalmente es el mismo que el anterior)';
...
$lang["museumplus_module_name_field"]='Campo de metadatos utilizado para contener el nombre de los módulos para los cuales el MpID es válido. Si no se establece, el complemento utilizará la configuración del módulo "Objeto" por defecto.';
...
$lang["museumplus_script_header"]='Configuración de script';
...
$lang["museumplus_confirm_delete_module_config"]='¿Está seguro de que desea eliminar esta configuración del módulo? ¡Esta acción no se puede deshacer!';
...
$lang["museumplus_error_unexpected_response"]='Código de respuesta inesperado recibido de MuseumPlus - %code';
...
Solo puede ignorar esta advertencia de forma segura si posteriormente recibió una notificación de finalización exitosa del script.';
$lang["museumplus_error_script_failed"]='El script de MuseumPlus no se pudo ejecutar porque había un bloqueo de proceso en su lugar. Esto indica que la ejecución anterior no se completó. Si necesita eliminar el bloqueo después de una ejecución fallida, ejecute el script de la siguiente manera: php museumplus_script.php --clear-lock';
...
$lang["museumplus_error_invalid_association"]='Asociación de módulo(s) no válida. ¡Por favor, asegúrese de que se hayan ingresado el módulo y/o el ID de registro correctos!';
...
$lang["page-title_museumplus_museumplus_object_details"] = 'MuseumPlus Detalles del Objeto';
