...
$lang["museumplus_host_api"]='API Host (somente para chamadas de API; geralmente o mesmo que acima)';
...
$lang["museumplus_secondary_links_field"]='Campo de metadados usado para armazenar os links secundários para outros módulos. O ResourceSpace irá gerar uma URL do MuseumPlus para cada um dos links. Os links terão um formato de sintaxe especial: nome_do_módulo:ID (por exemplo, "Objeto:1234")';
...
$lang["museumplus_mplus_id_field_helptxt"]='Deixe em branco para usar o ID técnico \'__id\' (padrão)';
$lang["museumplus_rs_uid_field"]='Campo UID do ResourceSpace';
$lang["museumplus_applicable_resource_types"]='Tipo(s) de recurso(s) aplicável(eis)';
...
$lang["museumplus_warning_script_not_completed"]='ATENÇÃO: O script do MuseumPlus não foi concluído desde \'%script_last_ran\'.
...
$lang["museumplus_error_script_failed"]='O script do MuseumPlus falhou ao ser executado porque um bloqueio de processo estava em vigor. Isso indica que a execução anterior não foi concluída. Se você precisar limpar o bloqueio após uma execução falha, execute o script da seguinte forma: php museumplus_script.php --clear-lock';
...
$lang["museumplus_error_invalid_association"]='Associação de módulo(s) inválida. Certifique-se de que o módulo correto e/ou o ID do registro tenham sido inseridos!';
