...
$lang["faces-match-threshold"] = 'Limite de correspondência facial: qual nível de semelhança é considerado uma correspondência ao procurar por rostos? Sugerido 30%.';
...
$lang["faces-tag-field"] = 'O campo que contém os nomes dos indivíduos marcados. Este deve ser um campo de Dropdown Dinâmico.';
$lang["faces-name"] = 'Nome';
$lang["faces-detect-on-upload"] = 'Escanear por rostos ao fazer upload?';
...
$lang["faces-show-view"] = 'Mostrar a funcionalidade de Faces de IA na página de visualização.';
