...
$lang["tms_link_selected_module_missing"] = 'Το όνομα του μοντέλου TMS είναι αυτή τη στιγμή ρυθμισμένο σε "%%MODULE%%" αλλά αυτή η επιλογή δεν είναι διαθέσιμη. Ελέγξτε τις επιλογές της αναπτυσσόμενης λίστας και ενημερώστε παρακάτω.';
$lang["page-title_tms_link_ajax_test"] = 'Δοκιμή Συνδέσμου TMS';
$lang["page-title_tms_link_setup"] = 'Ρύθμιση Πρόσθετου Σύνδεσης TMS';
$lang["page-title_tms_link_show_all"] = 'Εμφάνιση Δεδομένων TMS';
$lang["page-title_tms_link_show_raw"] = 'Εμφάνιση Ακατέργαστων Δεδομένων TMS';
$lang["page-title_tms_link_test"] = 'Δοκιμή Δεδομένων TMS';
$lang["page-title_tms_link_tms_details"] = 'Εμφάνιση Δεδομένων TMS';
$lang["page-title_tms_link_tms_module_config"] = 'Επεξεργασία Ρυθμίσεων Μονάδας TMS';