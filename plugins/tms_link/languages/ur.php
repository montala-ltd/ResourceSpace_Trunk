...
$lang["tms_link_selected_module_missing"] = 'TMS ماڈیول کا نام فی الحال "%%MODULE%%" پر سیٹ ہے لیکن یہ ایک دستیاب اختیار نہیں ہے۔ ڈراپ ڈاؤن اختیارات کا جائزہ لیں اور نیچے اپ ڈیٹ کریں۔';
$lang["page-title_tms_link_ajax_test"] = 'ٹیسٹ TMS لنک';
$lang["page-title_tms_link_setup"] = 'TMS لنک پلگ ان سیٹ اپ کریں';
$lang["page-title_tms_link_show_all"] = 'TMS ڈیٹا دکھائیں';
$lang["page-title_tms_link_show_raw"] = 'خام TMS ڈیٹا دکھائیں';
$lang["page-title_tms_link_test"] = 'ٹیسٹ TMS ڈیٹا';
$lang["page-title_tms_link_tms_details"] = 'TMS ڈیٹا دکھائیں';
$lang["page-title_tms_link_tms_module_config"] = 'TMS ماڈیول کی ترتیب میں ترمیم کریں';