...
$lang["tms_link_selected_module_missing"] = 'Назва модуля TMS наразі встановлена на "%%MODULE%%", але це не доступний варіант. Перегляньте варіанти в спадному списку та оновіть нижче.';
$lang["page-title_tms_link_ajax_test"] = 'Тестування посилання TMS';
$lang["page-title_tms_link_setup"] = 'Налаштування плагіна TMS Link';
$lang["page-title_tms_link_show_all"] = 'Показати дані TMS';
$lang["page-title_tms_link_show_raw"] = 'Показати сирі дані TMS';
$lang["page-title_tms_link_test"] = 'Тестові дані TMS';
$lang["page-title_tms_link_tms_details"] = 'Показати дані TMS';
$lang["page-title_tms_link_tms_module_config"] = 'Редагувати конфігурацію модуля TMS';