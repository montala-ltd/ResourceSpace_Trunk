...
$lang["tms_link_selected_module_missing"] = 'TMS 모듈 이름이 현재 "%%MODULE%%"로 설정되어 있지만, 이는 사용 가능한 옵션이 아닙니다. 드롭다운 옵션을 검토하고 아래에서 업데이트하십시오.';
$lang["page-title_tms_link_ajax_test"] = '테스트 TMS 링크';
$lang["page-title_tms_link_setup"] = 'TMS 링크 플러그인 설정';
$lang["page-title_tms_link_show_all"] = 'TMS 데이터 표시';
$lang["page-title_tms_link_show_raw"] = '원시 TMS 데이터 표시';
$lang["page-title_tms_link_test"] = '테스트 TMS 데이터';
$lang["page-title_tms_link_tms_details"] = 'TMS 데이터 표시';
$lang["page-title_tms_link_tms_module_config"] = 'TMS 모듈 구성 편집';