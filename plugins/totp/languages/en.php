...
$lang["totp_set_up_details"]="Scan the QR code below with a TOTP application on your mobile device, for example Google Authenticator available in the app store. When you have successfully scanned the code, enter the six digits displayed by the app to verify installation. On subsequent logins you will be asked for the code from the app.";
