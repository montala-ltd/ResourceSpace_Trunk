...
$lang["totp_set_up_details"] = '以下のQRコードをモバイルデバイスのTOTPアプリ（例えば、アプリストアで入手可能なGoogle Authenticator）でスキャンしてください。コードを正常にスキャンしたら、アプリに表示される6桁の数字を入力してインストールを確認してください。次回以降のログイン時には、アプリからのコードを求められます。';
