...
$lang["csv_user_import_condition1"] = 'CSVファイルがUTF-8でエンコードされていることを確認してください。';
$lang["csv_user_import_condition2"] = 'CSVファイルにはヘッダー行が必要です。';
$lang["csv_user_import_condition3"] = 'コンマ( , )を含む値がある列については、タイプをテキストにフォーマットして、引用符(" ")を追加する必要がないようにしてください。.csvファイルとして保存する場合は、テキストタイプのセルを引用符で囲むオプションを確認してください。';
