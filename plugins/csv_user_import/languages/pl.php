...
$lang["csv_user_import_condition1"] = 'Upewnij się, że plik CSV jest zakodowany w UTF-8';
$lang["csv_user_import_condition2"] = 'Plik CSV musi mieć wiersz nagłówka';
$lang["csv_user_import_condition3"] = 'Kolumny, które będą zawierać wartości zawierające przecinki (,), upewnij się, że sformatujesz je jako typ tekstowy, aby nie musieć dodawać cudzysłowów (""). Przy zapisywaniu pliku .csv, upewnij się, że zaznaczysz opcję cytowania komórek typu tekstowego';
...
$lang["plugin-csv_user_import-title"] = 'Import użytkowników CSV';
$lang["plugin-csv_user_import-desc"] = 'Umożliwia importowanie grupy użytkowników na podstawie wstępnie sformatowanego pliku CSV';

$lang["page-title_csv_user_import_csv_user_import"] = 'Import użytkowników z pliku CSV';